...
!(function () {
  ...
  const F = Array.prototype.slice,
    ...
    _e = (e, t) => ge.call(e, t),
    ke = (e, t) => _e(e, t) && void 0 !== e[t] && null !== e[t],
    Se = (e) => {
      const t = {};
      return (
        q(e, (e) => {
  ...
  const xt = () => Et(),
    _t = window.navigator.userAgent,
    kt = xt(),
    St = kt.browser,
    Nt = kt.os,
    Rt = kt.deviceType,
    At = -1 !== _t.indexOf("Windows Phone"),
    Tt = {
      transparentSrc:
  ...
  const Xn = (e, t, n) => {
    ...
    eo = (e, t) =>
      ((e, t) => {
        ...
        return _n(n) ? I.none() : I.from(n.querySelector(e)).map(Cn);
      })(t, e),
    ...
    Fo = (e, t) =>
      ((e, t) => {
        const n = void 0 === t ? document : t.dom;
        return _n(n) ? [] : V(n.querySelectorAll(e), Cn);
      })(t, e),
  ...
  const kr = (e, t, n, o) =>
    ...
    Sr = (e, t, n, o) =>
      ...
      ((e, t) => Qo(e) && _e(t.getNonEmptyElements(), e.nodeName))(t, e) ||
      _r(t) ||
      ((e) =>
        Qo(e) &&
        "A" === e.nodeName &&
    ...
    Kr = (e, t) => _e(e.getTransparentElements(), t),
    ...
    ks = {
      html4: Le(() => _s("html4")),
      html5: Le(() => _s("html5")),
      "html5-strict": Le(() => _s("html5-strict")),
    },
    Ss = (e, t) => {
      const { blockContent: n, phrasingContent: o, flowContent: r } = ks[e]();
      return "blocks" === t
        ? I.some(n)
        : "phrasing" === t
        ? I.some(o)
    ...
    Ks = (e, t) => {
      const n = null != t ? t : {};
      for (const t in e) _e(Ws, t) || (n[t] = e[t]);
      return (
    ...
    ca = (e, t = {}) => {
      ...
      const a = ns.forElement(Cn(e), {
        ...
        Y = {
          ...
          events: c,
          isBlock: (e) =>
            m(e) ? _e(u, e) : Qo(e) && (_e(u, e.nodeName) || Gr(l, e)),
          root: null,
          ...
          createHTML: (e, t, n = "") => {
            ...
            for (const e in t)
              ke(t, e) && (o += " " + e + '="' + I(t[e]) + '"');
            return Xe(n) && _e(l.getVoidElements(), e)
              ? o + " />"
              : o + ">" + n + "</" + e + ">";
          },
          createFragment: (t) => {
  ...
  const va = (e, t) => {
    ...
    _a = N("data-mce-annotation-classes"),
    ka = N("data-mce-annotation-attrs"),
    Sa = (e) => (t) => kn(t, e),
    Na = (e, t) => {
  ...
  const Pa = (e) => {
    ...
    Pi = (e) =>
      !((e) => Qo(e) && "true" === e.getAttribute("unselectable"))(e) && ki(e),
    Di = (e, t) =>
      Bi(e) &&
      ((e, t) => {
  ...
  const _l = (e) => "inline-command" === e.type || "inline-format" === e.type,
    kl = (e) => "block-command" === e.type || "block-format" === e.type,
    Sl = (e) => {
      var t;
    ...
    _c = Ll("table_tab_navigation"),
    kc = Ll("details_initial_state"),
  ...
  const Eu = hr,
    ...
    Tu = (e, t) => {
      ...
      return ru(e) ? (ku(t) ? Qi.before(t) : Qi.after(t)) : Qi.before(t);
    },
    Ou = (e, t, n) => {
      let o, r, s, a;
      ...
      if (t.isEqual(Qi.after(n)) && n.lastChild) {
        if (
          ...
          ru(e) && Su(n.lastChild) && _u(n.lastChild))
        )
          return ku(n.lastChild) ? Qi.before(n.lastChild) : a;
      } else a = t;
      const i = a.container();
      let l = a.offset();
      if (xu(i)) {
  ...
  const im = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
    ...
    sf = (e, t, n, o, r, s) => {
      ...
      if (
        ...
        d.length > 0 && Jt(e, `${_a()}`, d.join(","));
        const t = fe(l);
        t.length > 0 && Jt(e, `${ka()}`, t.join(","));
      }
    },
    af = (e, t, n, o, r) => {
      const s = vn("span", e);
            ...
            ((e, t, n, o) => {
              e.undoManager.transact(() => {
                ...
                if (
                  ...
                  ko(s, Vo), r.getRng().insertNode(s.dom), r.select(s.dom);
                } else
                  ym(r, !1, () => {
                    vm(e, (r) => {
  ...
  const ng = (e) => "textarea" === $t(e),
    ...
    xg = (e, t) => !Zo(t.dom) && (Sn(e, t) || kn(e, t)),
    _g = (e) => (t) => xg(e, t.start) && xg(e, t.finish),
    kg = (e) =>
      Pf.range(
        Cn(e.startContainer),
        e.startOffset,
  ...
  const wp = ["font", "text-decoration", "text-emphasis"],
    ...
    Up = (e, t) =>
      ((e, t, n) =>
        Sn(t, e) ? Bn(e, (e) => n(e) || kn(e, t)).slice(0, -1) : [])(e, t, L),
    ...
    rh = (e, t, n) =>
      th(t) ? kp(t) : kp(t) || zu(nh(e, t, n).dom, t).exists(kp),
    sh = (e) =>
      vu(e)
        .bind((e) => Zn(e, Kt))
        .exists((e) =>
    ...
    kh = (e, t) => t && _e(e.schema.getBlockElements(), $t(t)),
    Sh = (e, t, n, o = !0, r = !1) => {
      const s = xh(t, e.getBody(), n.dom),
        a = Xn(n, T(kh, e), ((i = e.getBody()), (e) => e.dom === i));
      var i;
      const l = ((e, t, n, o) => {
        ...
        s,
        e.schema,
        ((e, t) => _e(e.schema.getTextInlineElements(), $t(t)))(e, n)
      );
      ...
      if (
        ...
        const t = Lt(Tn(a), n)
          ...
          : Tn((i = a))
              ...
              .getOr([]);
        q(t.concat(In(n)), (t) => {
          kn(t, a) || Sn(t, a) || !Rr(e.schema, t) || wo(t);
        });
      }
      var i;
    },
    ...
    Yh = (e) => !kn(e.start, e.end),
    Gh = (e, t) =>
      mm(e.start, t).bind((n) => mm(e.end, t).bind((e) => Ft(kn(n, e), n))),
    Xh = (e) => (t) =>
      Gh(t, e).map((e) =>
        ...
        if (c && f.length > 1)
          if (Ab(t, i, c)) Nb(i, t);
            ...
            kb(t, s, a, u)
              ...
              (c = f[0]),
              (kb(t, s, a, c) || _b(c, "br")) && c.empty().remove();
          }
        else if (i.parent) {
          if ("li" === i.name) {
            let e = i.prev;
    ...
    lv = (e, t) => {
      ...
      const n = e.schema.getTextInlineElements();
      return _e(n, $t(t)) && !qu(t.dom) && !or(t.dom);
    },
    dv = {},
    cv = tr(["pre"]);
  ((e, t) => {
  ...
  const uv = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"],
    ...
    wv = (e, t, n, o) => {
      ...
      if (o && !1 !== t.merge_siblings) {
        const t = null !== (r = Cv(e, _m(o), o)) && void 0 !== r ? r : o;
        Cv(e, t, _m(t, !0));
      }
    },
    Ev = (e, t, n) => {
    ...
    kv = xl([{ keep: [] }, { rename: ["name"] }, { removed: [] }]),
    Sv = /^(src|href|style)$/,
    Nv = Dt.each,
    Rv = Tm,
    ...
    Fv = (e, t, n, o, r) => {
      ...
      if ("all" !== t.remove) {
        ...
        for (let t = 0; t < e.length; t++) {
          ...
          if (!a.isAttributeInternal(n)) return kv.keep();
        }
      }
      return "none" !== t.remove ? (Dv(e, l, t), kv.removed()) : kv.keep();
    },
    Uv = (e, t, n, o) =>
      Fv(e, t, n, o, o).fold(
        N(o),
  ...
  let { freeze: by, seal: vy, create: yy } = Object,
    { apply: Cy, construct: wy } = "undefined" != typeof Reflect && Reflect; // eslint-disable-line import/no-mutable-exports
  by ||
    (by = function (e) {
      return e;
    }),
  ...
  const Ey = Ly(Array.prototype.forEach),
    xy = Ly(Array.prototype.pop),
    _y = Ly(Array.prototype.push),
    ky = Ly(String.prototype.toLowerCase),
    Sy = Ly(String.prototype.toString),
    Ny = Ly(String.prototype.match),
    Ry = Ly(String.prototype.replace),
    Ay = Ly(String.prototype.indexOf),
    Ty = Ly(String.prototype.trim),
    Oy = Ly(Object.prototype.hasOwnProperty),
    By = Ly(RegExp.prototype.test),
    Py =
      ((Dy = TypeError),
      function () {
   ...
   */ function Iy(e) {
    for (let t = 0; t < e.length; t++) Oy(e, t) || (e[t] = null);
    return e;
  }
  /**
   ...
   */ function Uy(e, t) {
    for (; null !== e; ) {
      const n = hy(e, t);
      if (n) {
        if (n.get) return Ly(n.get);
        if ("function" == typeof n.value) return Ly(n.value);
      }
      e = py(e);
    }
    return function () {
  ...
  var dC = (function e() {
    let t =
      arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : lC();
    const n = (t) => e(t);
    /**
    ...
    let { IS_ALLOWED_URI: I } = iC,
      F = null;
    /**
     * We consider the elements and attributes below to be safe. Ideally
     * don't add any new ones but feel free to remove unwanted ones.
     */
    /* allowed element names */ const U = My({}, [
      ...zy,
      ...jy,
      ...Hy,
      ...Vy,
    ...
    /* Allowed attribute names */ let z = null;
    const j = My({}, [...Ky, ...Yy, ...Gy, ...Xy]);
    /*
     ...
     */ let H = Object.seal(
      ...
      ie = {},
      le = null;
    /* Explicitly forbidden tags (overrides ALLOWED_TAGS/ADD_TAGS) */ const de =
      My({}, [
        "annotation-xml",
        "audio",
        "colgroup",
    ...
    /* Tags that are safe for data: URIs */ let ce = null;
    const ue = My({}, ["audio", "video", "img", "source", "image", "track"]);
    /* Attributes safe for values like "javascript:" */ let me = null;
    const fe = My({}, [
        "alt",
        "class",
        "for",
    ...
    let be = he,
      ve = !1,
      ye = null;
    const Ce = My({}, [ge, pe, he], Sy);
    /* Parsing of strict XHTML documents */ let we = null;
    ...
    const ke = o.createElement("form"),
      ...
      Ne = function () {
        ...
        if (!_e || _e !== e) {
          if (
            ...
            (F = Oy(e, "ALLOWED_TAGS") ? My({}, e.ALLOWED_TAGS, xe) : U),
            (z = Oy(e, "ALLOWED_ATTR") ? My({}, e.ALLOWED_ATTR, xe) : j),
            (ye = Oy(e, "ALLOWED_NAMESPACES")
              ? My({}, e.ALLOWED_NAMESPACES, Sy)
              : Ce),
            (me = Oy(e, "ADD_URI_SAFE_ATTR")
              ? My(
                  Fy(fe),
            ...
            (ce = Oy(e, "ADD_DATA_URI_TAGS")
              ...
              : ue),
            (le = Oy(e, "FORBID_CONTENTS")
              ? My({}, e.FORBID_CONTENTS, xe)
              : de),
            ($ = Oy(e, "FORBID_TAGS") ? My({}, e.FORBID_TAGS, xe) : {}),
            (V = Oy(e, "FORBID_ATTR") ? My({}, e.FORBID_ATTR, xe) : {}),
            (ie = !!Oy(e, "USE_PROFILES") && e.USE_PROFILES),
            (q = !1 !== e.ALLOW_ARIA_ATTR), // Default true
            ...
            G && (W = !1),
            te && (ee = !0),
            /* Parse profile info */ ie &&
              ((F = My({}, Wy)),
              (z = []),
              !0 === ie.html && (My(F, zy), My(z, Ky)),
              !0 === ie.svg && (My(F, jy), My(z, Yy), My(z, Xy)),
              !0 === ie.svgFilters && (My(F, Hy), My(z, Yy), My(z, Xy)),
              !0 === ie.mathMl && (My(F, Vy), My(z, Gy), My(z, Xy))),
            /* Merge configuration parameters */ e.ADD_TAGS &&
              (F === U && (F = Fy(F)), My(F, e.ADD_TAGS, xe)),
            e.ADD_ATTR && (z === j && (z = Fy(z)), My(z, e.ADD_ATTR, xe)),
            e.ADD_URI_SAFE_ATTR && My(me, e.ADD_URI_SAFE_ATTR, xe),
            e.FORBID_CONTENTS &&
              (le === de && (le = Fy(le)), My(le, e.FORBID_CONTENTS, xe)),
            /* Add #text in case KEEP_CONTENT is set to true */ se &&
              (F["#text"] = !0),
            /* Add html, head and body to ALLOWED_TAGS in case WHOLE_DOCUMENT is true */ Z &&
              My(F, ["html", "head", "body"]),
            /* Add tbody to ALLOWED_TAGS in case tables are permitted, see #286, #365 */ F.table &&
              (My(F, ["tbody"]), delete $.tbody),
      ...
      Re = My({}, ["mi", "mo", "mn", "ms", "mtext"]),
      Ae = My({}, ["annotation-xml"]),
      Te = My({}, ["title", "style", "font", "a", "script"]),
      Oe = My({}, [...jy, ...Hy, ...$y]),
      Be = My({}, [...Vy, ...qy]),
      Pe = function (e) {
        _y(n.removed, { element: e });
        try {
      ...
      De = function (e, t) {
        try {
          _y(n.removed, { attribute: t.getAttributeNode(e), from: t });
        } catch (e) {
          _y(n.removed, { attribute: null, from: t });
        }
      ...
      Le = function (e) {
         ...
         */ if (be === he)
          try {
            t = new f().parseFromString(r, we);
          } catch (e) {}
        /* Use createHTMLDocument in case DOMParser is not available */ if (
          !t ||
          !t.documentElement
        ) {
      ...
      ze = function (e) {
        ...
        /* Now let's check the element's type and name */ const o = xe(
          e.nodeName
        );
        /* Execute a hook if present */
        /* Detect mXSS attempts abusing namespace confusion */
        if (
          (Ue("uponSanitizeElement", e, { tagName: o, allowedTags: F }),
          e.hasChildNodes() &&
            !Fe(e.firstElementChild) &&
            By(/<[/\w]/g, e.innerHTML) &&
            By(/<[/\w]/g, e.textContent))
        )
          return Pe(e), !0;
        /* Remove any occurrence of processing instructions */ if (
          7 === e.nodeType
        )
          return Pe(e), !0;
        ...
        /* Remove element if anything forbids its presence */ if (
          ...
          if (!$[o] && He(o)) {
            if (H.tagNameCheck instanceof RegExp && By(H.tagNameCheck, o))
              return !1;
            if (H.tagNameCheck instanceof Function && H.tagNameCheck(o))
              return !1;
          }
          /* Keep content except for bad-listed elements */ if (se && !le[o]) {
        ...
        /* Check whether element has a valid namespace */ return e instanceof
            ...
            return (
              ...
              (e.namespaceURI === pe
                ...
                ? // The only way to switch from SVG to HTML is via
                  ...
                  !(t.namespaceURI === pe && !Ae[o]) &&
                  !(t.namespaceURI === ge && !Re[o]) &&
                  !Be[n] &&
                  (Te[n] || !Oe[n])
                : !("application/xhtml+xml" !== we || !ye[e.namespaceURI]))
            );
          })(e)
          ? (Pe(e), !0)
          : /* Make sure that older browsers don't get fallback-tag mXSS */
          ("noscript" !== o && "noembed" !== o && "noframes" !== o) ||
            !By(/<\/no(script|embed|frames)/i, e.innerHTML)
          ? /* Sanitize element content to be template-safe */
            (G &&
              ...
              e.textContent !== t &&
                (_y(n.removed, { element: e.cloneNode() }),
                (e.textContent = t))),
            /* Execute a hook if present */ Ue(
      ...
      je = function (e, t, n) {
        ...
        if (oe && ("id" === t || "name" === t) && (n in o || n in ke))
          return !1;
        /* Allow valid data-* attributes: At least one character after "-"
          ...
          if (
            ...
            !(
              ...
              ("is" === t &&
                H.allowCustomizedBuiltInElements &&
                ((H.tagNameCheck instanceof RegExp && By(H.tagNameCheck, n)) ||
      ...
      He = function (e) {
        return "annotation-xml" !== e && Ny(e, M);
      },
      $e = function (e) {
        /* Execute a hook if present */
        Ue("beforeSanitizeAttributes", e, null);
        const { attributes: t } = e;
        /* Check if we have attributes; if not we might have a text node */ if (
          !t
        )
          return;
        const o = {
        ...
        let r = t.length;
        /* Go backwards over all attributes; safely remove bad ones */ for (
          ;
          r--;
          ...
          if (
            ...
            (o.attrValue = c),
            (o.keepAttr = !0),
            (o.forceKeepAttr = void 0), // Allows developers to see this is a property they can set
            Ue("uponSanitizeAttribute", e, o),
            (c = o.attrValue),
            o.forceKeepAttr)
          )
            continue;
          /* Remove attribute */
          /* Did the hooks approve of the attribute? */ if (!o.keepAttr) {
            De(a, e);
            continue;
          }
          ...
          /* Sanitize attribute content to be template-safe */ G &&
            Ey([A, T, O], (e) => {
              c = Ry(c, e, " ");
            });
          /* Is `value` valid for this attribute? */
          const m = xe(e.nodeName);
          if (je(m, d, c))
            if (
              ...
              /* Handle invalid data-* attribute set by try-catching it */ if (
                c !== u
              )
                try {
                  i
                    ? e.setAttributeNS(i, a, c)
                    : /* Fallback to setAttribute() for browser-unrecognized namespaces e.g. "x-schema". */
                      e.setAttribute(a, c),
                    Ie(e) ? Pe(e) : xy(n.removed);
                } catch (e) {}
            }
          else De(a, e);
        }
        /* Execute a hook if present */ Ue("afterSanitizeAttributes", e, null);
      },
      Ve = function e(t) {
        let n = null;
        const o = Me(t);
        /* Execute a hook if present */ for (
          Ue("beforeSanitizeShadowDOM", t, null);
          (n = o.nextNode());
    ...
    return (
      (n.sanitize = function (e) {
        ...
        if (
          ...
          if ("function" != typeof e.toString)
            throw Py("toString is not a function");
          if ("string" != typeof (e = e.toString()))
            throw Py("dirty is not a string, aborting");
        }
        /* Return dirty HTML if DOMPurify cannot run */ if (!n.isSupported)
          return e;
        ...
        /* Remove first element node (ours) if FORCE_BODY is set */ o &&
          J &&
          Pe(o.firstChild);
        /* Get node iterator */
        const c = Me(ae ? e : o);
        ...
        /* Return sanitized string or DOM */ if (ee) {
          if (te)
            for (d = k.call(o.ownerDocument); o.firstChild; )
              // eslint-disable-next-line unicorn/prefer-dom-node-append
              d.appendChild(o.firstChild);
          else d = o;
          return (
            (z.shadowroot || z.shadowrootmode) &&
              /*
        ...
        /* Serialize doctype if allowed */ return (
          Z &&
            ...
            By(sC, o.ownerDocument.doctype.name) &&
            (u = "<!DOCTYPE " + o.ownerDocument.doctype.name + ">\n" + u),
          /* Sanitize final string template-safe */ G &&
            Ey([A, T, O], (e) => {
              u = Ry(u, e, " ");
            }),
      ...
      (n.setConfig = function () {
        Ne(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}),
          (Q = !0);
      }),
      /**
      ...
      (n.addHook = function (e, t) {
        "function" == typeof t && ((R[e] = R[e] || []), _y(R[e], t));
      }),
      /**
       * RemoveHook
  ...
  const cC = Dt.each,
    ...
    fC = { ftp: 21, http: 80, https: 443, mailto: 25 },
    gC = ["img", "video"],
    pC = (e, t, n) => {
      const o = ((e) => {
        try {
  ...
  class hC {
    ...
    constructor(e, t = {}) {
      (this.path = ""), (this.directory = ""), (e = uC(e)), (this.settings = t);
      const n = t.base_uri,
        o = this;
      ...
      if (
        ...
        const t = n ? n.path : new hC(document.location.href).directory;
    ...
    toRelative(e) {
      if ("./" === e) return e;
      const t = new hC(e, { base_uri: this });
      if (
    ...
    toAbsolute(e, t) {
      const n = new hC(e, { base_uri: this });
  ...
  const CC = (e, t, n, o, r) => {
        ...
        if ((C(r) && (r.allowedTags[u] = !0), d && h && !g)) {
          if (
            (q(
              ...
              (e) => {
                Jt(f, e.name, "{$uid}" === e.value ? "mce_" + yC++ : e.value);
              }
            ),
            q(
    ...
    EC = (e, t) =>
      e.hasAttribute(vC) && ("id" === t || "class" === t || "style" === t),
    xC = (e, t) => e in t.getBoolAttrs(),
    _C = (e, t, n, o) => {
      ...
      for (let s = r.length - 1; s >= 0; s--) {
        const a = r[s],
          i = a.name,
          l = a.value;
        wC(t, n, o, e.tagName.toLowerCase(), i, l) || EC(e, i)
          ? xC(i, n) && e.setAttribute(i, i)
          : e.removeAttribute(i);
      }
    },
    kC = (e, t, n) => {
      ...
      if ("svg" === n)
        ...
        ((e, t) => {
          ...
          n.addHook("uponSanitizeElement", (e, n) => {
            var o;
            const r =
                null !== (o = n.tagName) && void 0 !== o
                  ? o
                  : e.nodeName.toLowerCase(),
              s = t.allow_mathml_annotation_encodings;
            if ("annotation" === r && p(s) && s.length > 0) {
              const t = e.getAttribute("encoding");
              m(t) && H(s, t) && (n.allowedTags[r] = !0);
            }
          }),
    ...
    AC = (e, t, n, o) => {
      ...
      for (let t = 0, r = a.length; t < r; t++) {
        ...
        Dr(i.name) || AC(i, r, n, o), e.append(i);
      }
    },
    TC = (e = {}, t = Ms()) => {
      const n = Jv(),
        ...
        a = ((e, t) => {
          ...
          if (e.sanitize) {
            ...
            return { sanitizeHtmlElement: r, sanitizeNamespaceElement: SC(e) };
          }
          return {
        ...
        g = (e, n) => {
          const o = m(n.attr(vC)),
            r = 1 === n.type && !_e(e, n.name) && !Zr(t, n) && !Dr(n.name);
          return 3 === n.type || (r && !o);
        },
        p = {
          schema: t,
          ...
          parse: (e, n = {}) => {
            ...
            Vr(t, c);
            const m = new Jg(d, 11);
            AC(m, c, t.getSpecialElements(), a.sanitizeNamespaceElement),
              (c.innerHTML = "");
            const [f, p] = ((e, t, n, o) => {
                const r = n.validate,
                  s = t.getNonEmptyElements(),
                  a = t.getWhitespaceElements(),
                  i = RC(
                    NC("script,style,head,html,body,title,meta,param"),
                    t.getBlockElements()
                  ),
                  l = Ds(t),
                  d = /[ \t\r\n]+/g,
    ...
    OC = (e, t, n) => {
      ...
      if (Ub(e)) {
        if (r.content !== o) {
          const t = TC({ validate: !1, forced_root_block: !1, ...n }).parse(
            r.content,
            { context: e.name }
          );
          return { ...r, content: t };
    ...
    DC = (e, t, n) => {
      ...
      {
        const o = OC(t, (t) => hf(e, { ...n, content: t }), BC(e));
        return o.content;
      }
    },
    LC = (e, t) => {
    ...
    FC = (e, t) => ({ element: e, cells: t }),
    UC = (e, t) => ({ x: e, y: t }),
    zC = (e, t) => nn(e, t).bind(Ze).getOr(1),
    jC = (e, t, n) => {
      const o = e.rows;
      return !!(o[n] ? o[n].cells : [])[t];
    },
    HC = (e) => X(e, (e, t) => (t.cells.length > e ? t.cells.length : e), 0),
    $C = (e, t) => {
      const n = e.rows;
      for (let e = 0; e < n.length; e++) {
        const o = n[e].cells;
        for (let n = 0; n < o.length; n++)
          if (kn(o[n], t)) return I.some(UC(n, e));
      }
      return I.none();
    },
    VC = (e, t, n, o, r) => {
              ...
              $C(e, n).map((n) =>
                ((e, t, n) => {
                  const o = t.x,
                    ...
                    s = n.x,
                    a = n.y,
                    i = r < a ? VC(e, o, r, s, a) : VC(e, o, a, s, r);
                  return IC(e.element, HC(i), i);
                })(e, t, n)
              )
            ))(r, n, o).map((e) => If([qC(e)]));
        })
        ...
        : ((e, t, n) =>
            t.length > 0 && t[0].collapsed
              ...
              : ((e, t, n) =>
                  ...
                  })(Cn(t.cloneContents()), WC(e, t, n)))(e, t[0], n))(e, t, n);
    },
    XC = (e, t) => t >= 0 && t < e.length && im(e.charAt(t)),
    ZC = (e) => ei(e.innerText),
    QC = (e) =>
      Qo(e)
        ? e.outerHTML
    ...
    ew = Le(() => document.implementation.createHTMLDocument("undo")),
    tw = (e) => {
      ...
      return ((e) => null !== e.querySelector("iframe"))(n)
        ? {
            type: "fragmented",
            fragments: Y(V(ce(n.childNodes), k(ei, QC)), (e) => e.length > 0),
            content: "",
            bookmark: null,
            beforeBookmark: null,
          }
    ...
    ow = (e) => ("fragmented" === e.type ? e.fragments.join("") : e.content),
    rw = (e) => {
      const t = vn("body", ew());
      return ko(t, ow(e)), q(Fo(t, "*[data-mce-bogus]"), Eo), _o(t);
    },
    sw = (e, t) =>
      !(!e || !t) &&
      (!!((e, t) => ow(e) === ow(t))(e, t) ||
    ...
    dw = (e) => ({
      ...
      undoManager: {
        beforeChange: (t, n) =>
          ((e, t, n) => {
            aw(t) && n.set(yl(e.selection));
          })(e, t, n),
        add: (t, n, o, r, s, a) =>
          ((e, t, n, o, r, s, a) => {
            const i = tw(e),
              l = Dt.extend(s || {}, i);
            if (!aw(o) || e.removed) return null;
        ...
        undo: (t, n, o) =>
          ((e, t, n, o) => {
            let r;
            return (
              t.typing && (t.add(), (t.typing = !1), iw(t, !1, n)),
              o.get() > 0 &&
                (o.set(o.get() - 1),
                (r = t.data[o.get()]),
                nw(e, r, !0),
        ...
        hasUndo: (t, n) =>
          ((e, t, n) =>
            n.get() > 0 || (t.typing && t.data[0] && !sw(tw(e), t.data[0])))(
            e,
            t,
            n
          ),
        ...
        transact: (e, t, n) =>
          ((e, t, n) => (lw(e, t), e.beforeChange(), e.ignore(n), e.add()))(
            e,
            t,
            n
          ),
                      ...
                      .getOr(""))(e);
                {
                  const n = ((e, t) => {
                    const n = e.selection.getRng(),
                      ...
                      s = Yg(e, dm(r)),
                      a = t.contextual
                        ? GC(Cn(e.getBody()), s, e.schema).dom
                        : n.cloneContents();
                    return (
                      a && o.appendChild(a),
    ...
    cw = (e) => _e(e.plugins, "rtc"),
    uw = (e) => (e.rtcInstance ? e.rtcInstance : dw(e)),
    mw = (e) => {
      const t = e.rtcInstance;
      if (t) return t;
      throw new Error("Failed to get RTC instance not yet initialized.");
    },
    fw = (e) => mw(e).init.bindEvents(),
    gw = (e) => (0 === e.dom.length ? (wo(e), I.none()) : I.some(e)),
    pw = (e, t, n, o, r) => {
      e.bind(
        (e) => (
  ...
  const bw = (e) => !(!e || !e.ownerDocument) && Sn(Cn(e.ownerDocument), Cn(e)),
    vw = (e, t, n, o) => {
      let r, s;
      const { selectorChangedWithUnbind: a } = ((e, t) => {
          ...
          ((e, t, n = {}) => {
            ...
            LC(e, o).each((t) => {
              ...
              ((e, t, n) => {
                ...
                const s = o.bind(Pn).filter(Yt).bind(gw),
                  a = r.bind(Dn).filter(Yt).bind(gw);
                pw(s, o, e, !0, n), pw(a, r, e, !1, n), e.collapse(!1);
        ...
        u = (e, t) => {
          if (!((e) => !!e && bw(e.startContainer) && bw(e.endContainer))(e))
            return;
          const n = d();
          if (
        ...
        f = {
          ...
          getContent: (e) =>
            ((e, t = {}) =>
              ((e, t, n) => mw(e).selection.getContent(t, n))(
                e,
    ...
    Ew = (e, t, n = {}) => {
      ...
      return LC(e, o)
        .map((t) => {
          const n = ((e, t, n) => uw(e).editor.setContent(t, n))(
            e,
            t.content,
            t
          );
          return MC(e, n.html, t), n.content;
        })
        .getOr(t);
    },
    xw =
    ...
    Pw = (e) =>
      Q(Sw, (t) => t.name === e).fold(
        () => e,
        (t) => (t.replacedWith ? `${e}, replaced by ${t.replacedWith}` : e)
      ),
    Dw = ca.DOM,
    Lw = (e) => I.from(e).each((e) => e.destroy()),
    Mw = (() => {
      const e = {};
      return {
        add: (t, n) => {
  ...
  const rE = (e, t) => {
    ...
    lE = { remove_similar: !0, inherit: !1 },
    dE = { selector: "td,th", ...lE },
    cE = {
      ...
      tableclass: { selector: "table", classes: ["%value"], ...lE },
    ...
    pE = (e, t) => {
      const n = (t && t.schema) || Ms({}),
        ...
        r = (e, t, s) => {
          ...
          const u = gE(a) ? a.siblings : void 0;
          return r(c, t, u);
        },
        s = fE.create("div");
      if (e.length > 0) {
    ...
    bE = (e, t) => {
      ...
      var d;
      l.length > 0
        ? (l[0].name || (l[0].name = i), (i = t.selector), (a = pE(l, e)))
        : (a = pE([i], e));
    ...
    vE = (e) => {
      ...
      return (
          ...
          })(n, e),
        {
          ...
          apply: (t, n, o) => {
            ((e, t, n, o) => {
              mw(e).formatter.apply(t, n, o);
            })(e, t, n, o);
          },
          remove: (t, n, o, r) => {
            ((e, t, n, o, r) => {
              mw(e).formatter.remove(t, n, o, r);
            })(e, t, n, o, r);
          },
          toggle: (t, n, o) => {
            ((e, t, n, o) => {
              mw(e).formatter.toggle(t, n, o);
            })(e, t, n, o);
          },
          match: (t, n, o, r) =>
            ((e, t, n, o, r) => mw(e).formatter.match(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          closest: (t) => ((e, t) => mw(e).formatter.closest(t))(e, t),
          matchAll: (t, n) =>
            ((e, t, n) => mw(e).formatter.matchAll(t, n))(e, t, n),
          matchNode: (t, n, o, r) =>
            ((e, t, n, o, r) => mw(e).formatter.matchNode(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          canApply: (t) => ((e, t) => mw(e).formatter.canApply(t))(e, t),
          formatChanged: (t, o, r, s) =>
            ((e, t, n, o, r, s) =>
              mw(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
          getCssText: T(bE, e),
        }
      );
    },
    ...
    CE = (e) => {
      const t = Br(),
        ...
        r = {
          ...
          beforeChange: () => {
            ((e, t, n) => {
              mw(e).undoManager.beforeChange(t, n);
            })(e, n, t);
          },
          add: (s, a) =>
            ((e, t, n, o, r, s, a) => mw(e).undoManager.add(t, n, o, r, s, a))(
              e,
              r,
              o,
              n,
          ...
          undo: () =>
            ((e, t, n, o) => mw(e).undoManager.undo(t, n, o))(e, r, n, o),
          redo: () => ((e, t, n) => mw(e).undoManager.redo(t, n))(e, o, r.data),
          clear: () => {
            ((e, t, n) => {
              mw(e).undoManager.clear(t, n);
            })(e, r, o);
          },
          reset: () => {
            ((e, t) => {
              mw(e).undoManager.reset(t);
            })(e, r);
          },
          hasUndo: () =>
            ((e, t, n) => mw(e).undoManager.hasUndo(t, n))(e, r, o),
          hasRedo: () =>
            ((e, t, n) => mw(e).undoManager.hasRedo(t, n))(e, r, o),
          transact: (t) =>
            ((e, t, n, o) => mw(e).undoManager.transact(t, n, o))(e, r, n, t),
          ignore: (t) => {
            ((e, t, n) => {
              mw(e).undoManager.ignore(t, n);
            })(e, n, t);
          },
          extra: (t, n) => {
            ((e, t, n, o, r) => {
              mw(e).undoManager.extra(t, n, o, r);
            })(e, r, o, t, n);
          },
        };
      return (
            ...
            e.on("init", () => {
              ...
              e.on("keydown", (e) => {
                ...
                if (
                  ...
                  return (
                    t.beforeChange(), iw(t, !0, n), t.add({}, e), void o.set(!0)
                  );
    ...
    EE = "data-mce-placeholder",
    xE = (e) => "keydown" === e.type || "keyup" === e.type,
    _E = (e) => {
      const t = e.keyCode;
    ...
    PE = (e, t, n, o) => (
      ...
      ((e, t) =>
        Sn(t, e)
          ...
          : I.none())(t, n).fold(T(OE, e, t, n, o), T(TE, e, t, n, o))
    ),
    DE = (e, t, n, o, r) => (t ? PE(e, o, n, r) : PE(e, n, o, r)),
    LE = (e, t) => {
      const n = Cn(e.getBody()),
        o = ((e, t, n, o) =>
          o.collapsed
            ? ((e, t, n, o) => {
                const r = SE(t, Qi.fromRangeStart(o)),
                  s = r.bind((o) =>
                ...
                return It(r, s, kE).filter(
                  (e) =>
                    ((e) => !kn(e.from.block, e.to.block))(e) &&
                    ((e, t) => {
                      const n = Cn(e);
                      return kn(NE(n, t.from.block), NE(n, t.to.block));
                    })(t, e) &&
                    ((e) =>
          ...
          (o) => () => {
            DE(n, t, o.from.block, o.to.block, e.schema).each((t) => {
    ...
    IE = (e) => {
      ...
      return ((e, t) => {
        ...
        return (
          !((e, t) => ME(e, t.startContainer) || ME(e, t.endContainer))(e, t) &&
          n &&
          o
        );
    ...
    FE = (e, t) => (e.selection.isCollapsed() ? I.none() : IE(e)),
    UE = (e, t, n, o, r) => I.from(t._selectionOverrides.showCaret(e, n, o, r)),
    zE = (e, t) =>
      ...
      t.collapsed
        ? ((e, t, n) => {
            const o = pu(1, e.getBody(), t),
              ...
              s = r.getNode();
            if (Wc(s)) return UE(1, e, s, !r.isAtEnd(), !1);
            const a = r.getNode(!0);
            if (Wc(a)) return UE(1, e, a, !1, !1);
            const i = pb(e.dom.getRoot(), r.getNode());
            return Wc(i) ? UE(1, e, i, !1, n) : I.none();
          })(e, t, n).getOr(t)
        : t,
    HE = (e) => Ip(e) || Pp(e),
    $E = (e) => Fp(e) || Dp(e),
    VE = (e, t, n, o, r, s) => {
      UE(o, e, s.getNode(!r), r, !0).each((n) => {
        if (t.collapsed) {
    ...
    qE = (e, t) =>
      ((e, t) => {
        ...
        if (a(d)) return I.some(() => VE(e, n, i.getNode(), o, t, d));
        const c = s(d);
        return c && a(c) && Cu(d, c)
          ? I.some(() => VE(e, n, i.getNode(), o, t, c))
          : I.none();
      })(e, t),
    WE = (e, t) => {
      const n = e.getBody();
    ...
    KE = (e) => {
      ...
      return (
        !t.collapsed &&
        (WE(e, !0).exists((e) => e.isEqual(Qi.fromRangeStart(t))) ||
          WE(e, !1).exists((e) => e.isEqual(Qi.fromRangeEnd(t))))
      );
    },
    YE = xl([
      { remove: ["element"] },
          ...
          ((e, t, n, o, r) => {
            ...
            ? ((e, t, n, o, r) => {
                ...
                return Fh(Cn(t), Cn(o.getNode()))
                  .map((t) =>
                    Rr(e, t) ? YE.remove(t.dom) : YE.moveToElement(s)
                  )
                  .orThunk(() => I.some(YE.moveToElement(s)));
              })(o, e, t, n, r)
            : (t && Fp(n)) || (!t && Ip(n))
            ? I.some(YE.moveToPosition(r))
            : I.none()
        );
        var s;
      }),
    XE = (e, t) => I.from(pb(e.getBody(), t)),
    ZE = (e, t) => {
          ...
          () =>
            ((e, t, n, o) => {
              const r = pu(t ? 1 : -1, e, n),
                ...
                a = Cn(e);
              return !t && Fp(s)
                ? I.some(YE.remove(s.getNode(!0)))
                : t && Ip(s)
                ? I.some(YE.remove(s.getNode()))
                : !t && Ip(s) && Qp(a, s, o)
                ? Jp(a, s, o).map((e) => YE.remove(e.getNode()))
                : t && Fp(s) && Zp(a, s, o)
                ? eh(a, s, o).map((e) => YE.remove(e.getNode()))
                : ((e, t, n, o) =>
                    ((e, t) => {
                      const n = t.getNode(!e),
                        o = e ? "after" : "before";
                      ...
                      ? ((e, t) =>
                          y(t)
                            ? I.none()
                            : e && hr(t.nextSibling)
                            ? I.some(YE.moveToElement(t.nextSibling))
                            : !e && hr(t.previousSibling)
                            ? I.some(YE.moveToElement(t.previousSibling))
                      ...
                      : GE(e, t, n, o).bind((t) =>
                          ((e, t, n) =>
                            n.fold(
                              (e) => I.some(YE.remove(e)),
                              (e) => I.some(YE.moveToElement(e)),
                              (n) =>
                                lu(t, n, e)
                                  ? I.none()
                                  : I.some(YE.moveToPosition(n))
                            ))(e, n, t)
                        ))(e, t, s, o);
    ...
    ex = (e) => e.hasOwnProperty("text"),
    tx = (e) => e.hasOwnProperty("marker"),
    nx = (e, t) => {
      const n = (e, n) => {
    ...
    sx = (e, t) =>
      e.selection.isCollapsed()
        ...
        : I.none(),
    ax = ir,
    ix = (e) => ax(e) && e.data[0] === Qa,
    lx = (e) => ax(e) && e.data[e.data.length - 1] === Qa,
    dx = (e) => {
      var t;
      return (
    ...
    cx = (e, t) =>
      e
        ? ((e) => {
            var t;
            if (ax(e.previousSibling))
              return (
                lx(e.previousSibling) || e.previousSibling.appendData(Qa),
                e.previousSibling
              );
            if (ax(e)) return ix(e) || e.insertData(0, Qa), e;
            {
              const n = dx(e);
              return (
                null === (t = e.parentNode) ||
        ...
        : ((e) => {
            ...
            if (ax(e.nextSibling))
              return (
                ix(e.nextSibling) || e.nextSibling.insertData(0, Qa),
                e.nextSibling
              );
            if (ax(e)) return lx(e) || e.appendData(Qa), e;
            {
              const o = dx(e);
              return (
                e.nextSibling
    ...
    mx = T(cx, !1),
    fx = (e, t) =>
      ir(e.container()) ? cx(t, e.container()) : cx(t, e.getNode()),
    gx = (e, t) => {
      const n = t.get();
    ...
    Cx = (e, t) => null === Wu(e, t),
    wx = (e, t, n) => Th(e, t, n).filter(T(Cx, t)),
    Ex = (e, t, n) => {
      const o = Ph(n);
      return wx(e, t, o).bind((e) =>
        ju(e, o).isNone() ? I.some(bx.start(e)) : I.none()
      );
    },
    xx = (e, t, n) => {
      const o = Bh(n);
      return wx(e, t, o).bind((e) =>
        zu(e, o).isNone() ? I.some(bx.end(e)) : I.none()
      );
    },
    _x = (e, t, n) => {
      const o = Ph(n),
    ...
    kx = (e) => !Ah(Nx(e)),
    Sx = (e, t, n) => hx([yx, Ex, xx, _x], [e, t, n]).filter(kx),
    Nx = (e) => e.fold(R, R, R, R),
    Rx = (e) => e.fold(N("before"), N("start"), N("end"), N("after")),
    Ax = (e) => e.fold(bx.before, bx.before, bx.after, bx.after),
    Tx = (e) => e.fold(bx.start, bx.start, bx.end, bx.end),
    Ox = (e, t, n, o, r, s) =>
    ...
    Bx = (e, t) =>
      e.fold(M, (e) => {
        return (o = t), !(Rx((n = e)) === Rx(o) && Nx(n) === Nx(o));
        var n, o;
      }),
    Px = (e, t) =>
      e
        ? t.fold(k(I.some, bx.start), I.none, k(I.some, bx.after), I.none)
        : t.fold(I.none, k(I.some, bx.before), I.none, k(I.some, bx.end)),
    Dx = (e, t, n) => {
      const o = e ? 1 : -1;
      return (
  ...
  const Mx = (e, t) => (e === wu.Backwards ? oe(t) : t),
    Ix = (e, t, n) => (e === wu.Forwards ? t.next(n) : t.prev(n)),
    Fx = (e, t, n, o) =>
      ...
      for (; s; ) {
        ...
        if (fr(n.getNode(!1)))
          return t === wu.Forwards
            ...
            : { positions: Mx(t, a), breakType: Lx.Br, breakAt: I.some(n) };
        if (n.isVisible()) {
          if (e(s, n)) {
            const e = Fx(0, t, s, n);
            return { positions: Mx(t, a), breakType: e, breakAt: I.some(n) };
          }
          a.push(n), (s = n);
        } else s = n;
      }
      return { positions: Mx(t, a), breakType: Lx.Eol, breakAt: I.none() };
    },
    zx = (e, t, n, o) =>
      t(n, o)
        .breakAt.map((o) => {
    ...
    Hx = (e, t) => le(t.getClientRects()).bind((t) => jx(e, t.left)),
    $x = T(Ux, Qi.isAbove, -1),
    Vx = T(Ux, Qi.isBelow, 1),
    qx = T(zx, -1, $x),
    Wx = T(zx, 1, Vx),
    Kx = (e, t) => $x(e, t).breakAt.isNone(),
    Yx = (e, t) => Vx(e, t).breakAt.isNone(),
    Gx = (e, t) => Hx(qx(e, t), t),
    Xx = (e, t) => Hx(Wx(e, t), t),
    Zx = hr,
    Qx = (e, t) => Math.abs(e.left - t),
    Jx = (e, t) => Math.abs(e.right - t),
    e_ = (e, t) =>
      Be(e, (e, n) => {
        const o = Math.min(Qx(e, t), Jx(e, t)),
          r = Math.min(Qx(n, t), Jx(n, t));
        return (r === o && ke(n, "node") && Zx(n.node)) || r < o ? n : e;
      }),
    t_ = (e) => {
      const t = (t) =>
        V(t, (t) => {
  ...
  const r_ = (e, t, n, o, r, s) => {
    ...
    s_ = T(r_, o_.Up, bi, vi),
    a_ = T(r_, o_.Down, vi, bi),
    i_ = (e) => De(e.getClientRects()),
    l_ = (e) => (t) => ((e, t) => t.line > e)(e, t),
    d_ = (e) => (t) => ((e, t) => t.line === e)(e, t),
    c_ = (e, t) => {
      e.selection.setRng(t), bg(e, e.selection.getRng());
    },
    u_ = (e, t, n) => I.some(jE(e, t, n)),
    m_ = (e, t, n, o, r, s) => {
      ...
      if (!n.collapsed) {
        const o = Ci(n);
        if (s(o)) return UE(t, e, o, t === wu.Backwards, !1);
        if (KE(e)) {
      ...
      if (d(c)) return zE(e, c.getNode(!a));
      let u = l(c);
      const m = mi(n);
      if (!u) return m ? I.some(n) : I.none();
      if (((u = Oh(a, u)), d(u))) return UE(t, e, u.getNode(!a), a, !1);
      const f = l(u);
      return f && d(f) && Cu(u, f)
        ? UE(t, e, f.getNode(!a), a, !1)
        : m
        ? u_(e, u.toRange(), !1)
        : I.none();
    },
    f_ = (e, t, n, o, r, s) => {
      ...
      if (((g = o(a) ? a.getNode() : r(a) ? a.getNode(!0) : Ci(n)), g)) {
        ...
        let o = e_(Y(n, d_(1)), m);
        if (o) return u_(e, o.position.toRange(), !1);
        if (((o = De(Y(n, d_(0)))), o)) return u_(e, o.position.toRange(), !1);
      }
      return 0 === u.length
        ? g_(e, l)
            .filter(l ? r : o)
            .map((t) => jE(e, t.toRange(), !1))
        : I.none();
    },
    g_ = (e, t) => {
      const n = e.selection.getRng(),
    ...
    v_ = (e, t, n) => px(t, n).map((t) => (h_(e, t), n)),
    y_ = (e, t, n) => {
      const o = e.getBody(),
        r = ((e, t, n) => {
          ...
          .orThunk(() =>
            ((e, t, n, o, r) => {
              ...
              return Mu(e, n, s)
                ...
                .fold(
                  () => o.map(Ax),
                  (r) => Sx(t, n, r).map(T(Ox, e, t, n, s, r)).filter(T(Bx, o))
                )
                .filter(kx);
            })(e, t, n, s, o)
          );
      })(n, T(Rh, e), o, r).bind((n) => v_(e, t, n));
    },
    C_ = (e, t, n) => !!Nd(e) && y_(e, t, n).isSome(),
    w_ = (e, t, n) =>
      !!Nd(t) &&
      ((e, t) => {
          ...
          Nd(e) &&
            (((e, t, n) => {
              const o = V(
                ...
                r = Y(o, e),
                s = Y(n, e);
              q(re(r, s), T(b_, !1)), q(re(s, r), T(b_, !0));
            })(n, e.dom, o.parents),
            ((e, t) => {
              const n = t.get();
            ...
            ((e, t, n, o) => {
              if (t.selection.isCollapsed()) {
                ...
                q(r, (o) => {
                  ...
                  Sx(e, t.getBody(), r).bind((e) => v_(t, n, e));
                });
              }
            })(n, e, t, o.parents));
        }),
    ...
    k_ = (e, t, n) => {
      if (Nd(e)) {
        const o = g_(e, t).getOrThunk(() => {
          const n = e.selection.getRng();
          return t ? Qi.fromRangeEnd(n) : Qi.fromRangeStart(n);
        });
        return Sx(T(Rh, e), e.getBody(), o).exists((t) => {
          const o = Ax(t);
          return px(n, o).exists((t) => (h_(e, t), !0));
        });
      }
      return !1;
    },
    S_ = (e, t) => (n) => px(t, n).map((t) => () => h_(e, t)),
    N_ = (e, t, n, o) => {
      const r = e.getBody(),
        s = T(Rh, e);
      e.undoManager.ignore(() => {
        e.selection.setRng(
          ...
          Lh(e),
          Sx(s, r, Qi.fromRangeStart(e.selection.getRng()))
            .map(Tx)
            .bind(S_(e, t))
            .each(D);
      }),
      ...
      if (e.selection.isCollapsed() && Nd(e)) {
        ...
        return ((e, t, n, o) => {
          ...
          return a
            .bind((e) =>
              n
                ? e.fold(N(I.some(Tx(e))), I.none, N(I.some(Ax(e))), I.none)
                : e.fold(I.none, N(I.some(Ax(e))), I.none, N(I.some(Tx(e))))
            )
            .map(S_(e, t))
            .getOrThunk(() => {
              const i = Iu(n, r, o),
    ...
    B_ = (e) => {
      const t = ((e) => A_(e, (t) => e.schema.isBlock($t(t))))(e);
      return O_(e, t);
    },
    P_ = (e, t) => {
      const n = Y(
        ((e) => A_(e, (t) => e.schema.isBlock($t(t)) || ((e) => jn(e) > 1)(t)))(
          e
        ),
        T_
      );
    ...
    L_ = (e) => ir(e.startContainer),
    M_ = (e) => {
      const t = e.selection.getRng();
      return (
        ((e) => 0 === e.startOffset && L_(e))(t) &&
        ((e, t) => {
    ...
    F_ = (e) => (
      ((e) => {
        ...
        return (
          t.collapsed &&
          (L_(t) || e.dom.isEmpty(t.startContainer)) &&
          !((e) => {
            return (
      ...
      e.selection.isCollapsed()
        ? ((e, t) => {
            ...
            return n(r)
              ...
              : I.from(Oh(t, r))
                  .filter((e) => n(e) && Cu(r, e))
                  .bind((n) => U_(e, t, n.getNode(!t)));
          })(e, t)
        : ((e, t) => {
            const n = e.selection.getNode();
            return yr(n) ? U_(e, t, n) : I.none();
          })(e, t),
    j_ = (e) => Ze(null != e ? e : "").getOr(0),
    H_ = (e, t) =>
    ...
    K_ = (e) => W_(e, "outdent"),
    Y_ = (e) => {
      if (e.selection.isCollapsed() && $_(e)) {
        const t = e.dom,
          n = e.selection.getRng(),
          o = Qi.fromRangeStart(n),
          r = t.getParent(n.startContainer, t.isBlock);
        if (null !== r && qp(Cn(r), o, e.schema)) return I.some(() => K_(e));
      }
      return I.none();
    },
    G_ = (e, t, n) =>
      ue([Y_, JE, qE, (e, n) => R_(e, t, n), LE, gb, sx, z_, FE, I_, rx], (t) =>
        t(e, n)
    ...
    X_ = (e) =>
      void 0 === e.touches || 1 !== e.touches.length
        ? I.none()
        : I.some(e.touches[0]),
    Z_ = (e, t) => _e(e, t.nodeName),
    Q_ = (e, t) =>
      !!ir(t) ||
      (!!Qo(t) && !(Z_(e.getBlockElements(), t) || rm(t) || Gr(e, t) || Lr(t))),
    J_ = (e, t) => {
      if (ir(t)) {
        if (0 === t.data.length) return !0;
        if (/^\s+$/.test(t.data))
          return !t.nextSibling || Z_(e, t.nextSibling) || Lr(t.nextSibling);
      }
      return !1;
    },
    ek = (e) => e.dom.create(ql(e), Wl(e)),
    tk = (e, t, n) => {
      const o = Cn(ek(e)),
        r = Xa();
      bo(o, r), n(t, o);
    ...
    nk = (e) => (t) => -1 !== (" " + t.attr("class") + " ").indexOf(e),
    ok = (e, t, n) =>
      function (o) {
        const r = arguments,
          s = r[r.length - 2],
    ...
    ak = (e, t) => {
      ...
      if (n)
        return "compositionstart" === t.type
          ? (t.preventDefault(), t.stopPropagation(), void sk(e, n))
          : void (ai(n) && (sk(e, n), e.undoManager.add()));
    },
    ik = hr,
    lk = (e, t, n) => {
    ...
    dk = (e, t) =>
      ((e, t) => {
        const n = t ? wu.Forwards : wu.Backwards,
          o = e.selection.getRng();
        return ((e, t, n) => m_(t, e, n, Ip, Fp, ik))(n, e, o).orThunk(
          () => (lk(e, n, o), I.none())
        );
      })(
        e,
      ...
      ((e, t) => {
        ...
        return ((e, t, n) =>
          f_(
            ...
            (e) => Fp(e) || Mp(e),
            ik
          ))(n, e, o).orThunk(() => (lk(e, n, o), I.none()));
      })(e, t).exists((t) => (c_(e, t), !0)),
    uk = (e, t) => p_(e, t, t ? Fp : Ip),
    mk = (e, t) =>
      WE(e, !t)
        .map((n) => {
          const o = n.toRange(),
    ...
    gk = (e, t) =>
      ...
      ((e, t) => {
        ...
        return ((e, t, n) => {
          const o = T(kn, t);
          return Zn(Cn(e.container()), (e) => n.isBlock($t(e)), o).filter(fk);
        })(o, n, e.schema).exists(() => {
          if (((e, t, n) => (t ? Yx(e.dom, n) : Kx(e.dom, n)))(n, t, o)) {
            const o = tk(e, n, t ? bo : ho);
      ...
      ((e, t) =>
        t
          ...
          : I.from(e.dom.getParent(e.selection.getNode(), "summary"))
              ...
              .getOr(!1))(e, t),
    hk = { shiftKey: !1, altKey: !1, ctrlKey: !1, metaKey: !1, keyCode: 0 },
    bk = (e, t) =>
      t.keyCode === e.keyCode &&
    ...
    wk = (e, t) => {
      const n = t ? wu.Forwards : wu.Backwards,
        o = e.selection.getRng();
      return m_(e, n, o, Pp, Dp, yr).exists((t) => (c_(e, t), !0));
    },
    Ek = (e, t) => {
      const n = t ? 1 : -1,
        o = e.selection.getRng();
      return f_(e, n, o, Pp, Dp, yr).exists((t) => (c_(e, t), !0));
    },
    xk = (e, t) => p_(e, t, t ? Dp : Pp),
    _k = xl([
      { none: ["current"] },
      { first: ["current"] },
    ...
    kk = { ..._k, none: (e) => _k.none(e) },
    Sk = (e, t, n) =>
      te(In(e), (e) => (xn(e, t) ? (n(e) ? [e] : []) : Sk(e, t, n))),
    Nk = (e, t) => to(e, "table", t),
    Rk = (e, t, n, o, r = M) => {
      const s = 1 === o;
      ...
      if (s && n >= e.length - 1) return kk.last(e[e.length - 1]);
      {
        const s = n + o,
          a = e[s];
        return r(a) ? kk.middle(t, a) : Rk(e, t, s, o, r);
      }
    },
    Ak = (e, t) =>
      Nk(e, t).bind((t) => {
        const n = Sk(t, "th,td", M);
        return J(n, (t) => kn(e, t)).map((e) => ({ index: e, all: n }));
      }),
    Tk = ["img", "br"],
    Ok = (e) => {
      return (
    ...
    Lk = (e, t, n) => {
      const o = e(t, n);
      return ((e) => e.breakType === Lx.Wrap && 0 === e.positions.length)(o) ||
        (!fr(n.getNode()) &&
          ((e) => e.breakType === Lx.Br && 1 === e.positions.length)(o))
    ...
    zk = (e, t, n, o) => {
          ...
          ((e, t) =>
            le(t.getClientRects())
              ...
              .bind((e) => {
                return Hx(
                  $u((n = e))
                    .map((e) => $x(n, e).positions.concat(e))
                    .getOr([]),
                  t
                );
                var n;
      ...
      if (t && Ik(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            de(t.getClientRects())
              .bind((t) => Dk(e, t.left, t.top))
              .bind((e) => {
                return Hx(
                  Hu((n = e))
                    .map((e) => [e].concat(Vx(n, e).positions))
                    .getOr([]),
                  t
                );
                var n;
            ...
            .orThunk(() =>
              le(n.getClientRects()).bind((n) => jx(Wx(e, Qi.after(t)), n.left))
            )
    ...
    Vk = (e, t, n) =>
      n.fold(
        ...
        (n) =>
          e.mode.isReadOnly()
            ? I.none()
            : (e.execCommand("mceTableInsertRowAfter"), qk(e, t, n))
      ),
    qk = (e, t, n) => {
      return Vk(
        e,
    ...
    Yk = (e, t) => ({ container: e, offset: t }),
    Gk = ca.DOM,
    Xk = (e) => (t) => e === t ? -1 : 0,
    Zk = (e, t, n) => {
      if (ir(e) && t >= 0) return I.some(Yk(e, t));
      {
        const o = Fa(Gk);
        return I.from(o.backwards(e, t, Xk(e), n)).map((e) =>
          Yk(e.container, e.container.data.length)
        );
      }
    },
    Qk = (e, t, n) => {
      ...
      const o = e.data;
      if (t >= 0 && t <= o.length) return I.some(Yk(e, t));
      {
        const o = Fa(Gk);
        return I.from(o.backwards(e, t, Xk(e), n)).bind((e) => {
          const o = e.container.data;
          return Qk(e.container, t + o.length, n);
        });
      }
    },
    Jk = (e, t, n) => {
      if (!ir(e)) return I.none();
      const o = e.data;
      if (t <= o.length) return I.some(Yk(e, t));
      {
        const r = Fa(Gk);
        return I.from(r.forwards(e, t, Xk(e), n)).bind((e) =>
          Jk(e.container, t - o.length, n)
        );
      }
    },
    eS = (e, t, n, o, r) => {
    ...
    oS = (e, t, n, o = !1) => {
      ...
      return eS(
        ...
        return 0 !== r.lastIndexOf(n)
          ? I.none()
          : I.some({ text: nS(r, n), range: o, trigger: n });
      });
    },
    rS = (e) => {
      if (((e) => 3 === e.nodeType)(e)) return Yk(e, e.data.length);
      {
        const t = e.childNodes;
        return t.length > 0 ? rS(t[t.length - 1]) : Yk(e, t.length);
      }
    },
    sS = (e, t) => {
      const n = e.childNodes;
        ...
        i = Y(
          ...
          (t) =>
            ...
            t.matches.getOrThunk(() =>
              ((e) => (t) => {
                const n = sS(t.startContainer, t.startOffset);
                return !((e, t) => {
                  var n;
                  const o =
  ...
  const lS = (e, t, n) => (e.stype === iS.Error ? t(e.serror) : n(e.svalue)),
    dS = (e) => ({ stype: iS.Value, svalue: e }),
    cS = (e) => ({ stype: iS.Error, serror: e }),
    uS = lS,
    mS = (e) =>
      f(e) && fe(e).length > 100
        ? " removed due to size"
        : JSON.stringify(e, null, 2),
    fS = (e, t) => cS([{ path: e, getErrorInfo: t }]),
    gS = (e, t) => ({
      extract: (n, o) =>
        xe(o, e).fold(
          () =>
    ...
    hS = pS((e, t) => (g(e) && g(t) ? hS(e, t) : t)),
    bS = pS((e, t) => t),
    vS = (e) => ({ tag: "defaultedThunk", process: N(e) }),
    yS = (e) => {
      const t = ((e) => {
        const t = [],
          n = [];
    ...
    wS = (e) => ({
      extract: (t, n) => {
        return (
          (o = e(n)),
          (r = (e) => ((e, t) => fS(e, N(t)))(t, e)),
          o.stype === iS.Error ? r(o.serror) : o
        );
        var o, r;
      },
      toString: N("val"),
          ...
          e.fold(
            ...
            (e) => {
              ...
              return (
                ...
                (a = I.some),
                s.stype === iS.Value
                  ? { stype: iS.Value, svalue: a(s.svalue) }
                  : s
              );
              var s, a;
            }
    ...
    NS = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) =>
            e.stype === iS.Error
              ? { stype: iS.Error, serror: t(e.serror) }
              : e)(t.extract([e], n), (e) => ({ input: n, errors: e })))(
          e,
          t,
          n
        )),
        lS(o, El.error, El.value)
      );
      var o;
    },
    RS = (e, t) => gS(e, he(t, kS)),
    ...
    TS = (e, t) =>
      wS((n) => {
        const o = typeof n;
        return e(n) ? dS(n) : cS(`Expected type: ${t} but got: ${o}`);
      }),
    OS = TS(E, "number"),
    BS = TS(m, "string"),
    PS = TS(b, "boolean"),
    ...
    IS = (e, t) => LS(e, e, { tag: "required", process: {} }, t),
    FS = (e) => IS(e, BS),
    US = (e) => IS(e, DS),
    zS = (e, t) => LS(e, e, { tag: "option", process: {} }, t),
    jS = (e) => zS(e, BS),
    HS = (e, t, n) => LS(e, e, vS(t), n),
    $S = (e, t) => HS(e, t, OS),
    VS = (e, t) => HS(e, t, BS),
    qS = (e, t, n) =>
      HS(
    ...
    aN = kS([
      ...
      FS("trigger"),
      $S("minChars", 1),
      (1, ((e, t) => LS(e, e, vS(1), AS()))("columns")),
      $S("maxResults", 10),
      ("matches", zS("matches", DS)),
      GS,
      XS,
      ((iN = BS), HS("highlightOn", [], SS(iN))),
    ]);
  var iN;
  const lN = [oN, eN, JS, QS, ZS, VS("context", "mode:design")],
    dN = [nN].concat(lN),
    cN = [
      KS("predicate", L),
      qS("scope", "node", ["node", "editor"]),
      qS("position", "selection", ["node", "selection", "line"]),
    ],
    uN = lN.concat([sN("contextformbutton"), rN, XS, MS("original", R)]),
    mN = dN.concat([sN("contextformbutton"), rN, XS, MS("original", R)]),
    fN = lN.concat([sN("contextformbutton")]),
    gN = dN.concat([sN("contextformtogglebutton")]),
    pN = RS("type", { contextformbutton: uN, contextformtogglebutton: mN });
  kS(
    [
      sN("contextform"),
      KS("initValue", N("")),
      tN,
      ((e, t) => LS(e, e, { tag: "required", process: {} }, SS(t)))(
        "commands",
        pN
      ),
      zS(
        "launch",
        RS("type", { contextformbutton: fN, contextformtogglebutton: gN })
      ),
    ].concat(cN)
  );
  const hN = (e) => {
      const t = e.ui.registry.getAll().popups,
        n = he(t, (e) => {
          return ((t = e), NS("Autocompleter", aN, t)).fold((e) => {
            throw new Error(
              "Errors: \n" +
                ((e) => {
                  const t =
        ...
        a = (a) => {
          ((n) =>
            t
              .get()
              .map((t) =>
                oS(e.dom, e.selection.getRng(), t.trigger, !0).bind((t) =>
                  aS(e, s, t, n)
                )
              )
              .getOrThunk(() =>
                ((e, t) => {
                  const n = t(),
                    o = e.selection.getRng();
                  return ((e, t, n) => ue(n.triggers, (n) => oS(e, t, n)))(
                    e.dom,
                    o,
                    n
                  ).bind((n) => aS(e, t, n));
    ...
    wN = (e, t) => I.from(e.getParent(t.container(), "details")),
    EN = (e, t) => wN(e, t).isSome(),
    xN = (e, t) => {
      const n = t.getNode();
      ...
      if ("character" === n) {
        ...
        return (
          !!(
            l &&
            (t ? c : d) &&
            Iu(!t, s, n).exists((e) => EN(o, e) && !Mt(i, wN(o, e)))
          ) ||
          Iu(t, s, n).fold(L, (n) => {
            const r = wN(o, n);
            if (EN(o, n) && !Mt(i, r)) {
    ...
    ON = xt(),
    BN = ON.os,
    PN = BN.isMacOS() || BN.isiOS(),
    DN = ON.browser.isFirefox(),
    LN = (e, t) => {
      const n = e.dom,
    ...
    zN = (e, t, n, o, r = !0, s, a) => {
      ...
      return UN(e, f), FN(g), f;
    },
    jN = (e, t) => {
      const n = null == e ? void 0 : e.parentNode;
      return C(n) && n.nodeName === t;
    },
    HN = (e) => C(e) && /^(OL|UL|LI)$/.test(e.nodeName),
    $N = (e) => C(e) && /^(LI|DT|DD)$/.test(e.nodeName),
    VN = (e) => {
      const t = e.parentNode;
      return $N(t) ? t : e;
    },
    ...
    KN = (e, t) => t && "A" === t.nodeName && e.isEmpty(t),
    YN = (e, t) =>
      e.nodeName === t ||
    ...
    ZN = {
      insert: (e, t) => {
        ...
        const i = e.dom,
          ...
          p = d.collapsed && g,
          b = (t, o) => zN(e, n, k, _, Xl(e), t, o),
          v = (e) => {
            const t = XN(e, n, o);
            if (ir(n) && (e ? t > 0 : t < n.data.length)) return !1;
            if ((n.parentNode === k || n === k) && a && !e) return !0;
            if (e && Qo(n) && n === k.firstChild) return !0;
            if (YN(n, "TABLE") || YN(n, "HR"))
              return ((e, t) =>
                "BR" === e.nodeName ||
        ...
        E ||
          (n = ((e, t, n, o, r) => {
            var s, a;
            const i = e.dom,
              l = null !== (s = MN(i, o)) && void 0 !== s ? s : i.getRoot();
        ...
        if (/^(LI|DT|DD)$/.test(r) && Qo(s) && i.isEmpty(k))
          return void ((e, t, n, o, r) => {
            ...
            var l;
            HN((l = n)) && HN(l.parentNode) && (r = "LI");
            const d = $N(o) ? WN(o) : void 0;
            let c = $N(o) && d ? t(r, { style: WN(o) }) : t(r);
            if (qN(n, o, !0) && qN(n, o, !1))
              if (jN(n, "LI")) {
                const e = VN(n);
                s.insertAfter(c, e),
                  ((e) => {
              ...
              jN(n, "LI")
                ? (s.insertAfter(c, VN(n)),
                  c.appendChild(s.doc.createTextNode(" ")),
                  c.appendChild(n))
                : i.insertBefore(c, n),
                s.remove(o);
            else if (qN(n, o, !1)) s.insertAfter(c, VN(n)), s.remove(o);
            else {
              n = VN(n);
        ...
        if (!(p || (k !== e.getBody() && GN(i, k)))) return;
        ...
        if (p)
        ...
        else if (oi(k)) (R = ui(k)), i.isEmpty(k) && FN(k), UN(e, R), LN(e, R);
        else if (v(!1)) R = w();
        else if (v(!0) && N) {
          ...
          const t = ((e) => {
            ...
            return (
              t.setStart(
                e.startContainer,
                XN(!0, e.startContainer, e.startOffset)
              ),
              t.setEnd(e.endContainer, XN(!1, e.endContainer, e.endOffset)),
              t
            );
          })(d).cloneRange();
          t.setEndAfter(k);
          ...
          ((e) => {
            ...
            i.isEmpty(k) && FN(k),
            R.normalize(),
            i.isEmpty(R) ? (i.remove(R), w()) : (UN(e, R), LN(e, R));
        }
    ...
    eR = (e, t) => {
      tR(e.getBody(), t) || po(Cn(t), vn("br"));
      const n = vn("br");
      po(Cn(t), n), QN(e, n.dom, !1), e.undoManager.add();
    },
    tR = (e, t) => {
      return (
        (n = Qi.after(t)),
    ...
    nR = (e) => e && "A" === e.nodeName && "href" in e,
    oR = (e) => e.fold(L, nR, nR, L),
    rR = (e, t) => {
      t.fold(_, T(JN, e), T(eR, e), _);
    },
    sR = {
      insert: (e, t) => {
        const n = ((e) => {
          ...
          return Sx(t, e.getBody(), n).filter(oR);
        })(e);
        n.isSome()
          ? n.each(T(rR, e))
          : ((e, t) => {
    ...
    cR = (e, t) => (n, o) => {
      const r =
        ((e) => IN(e).fold(N(""), (e) => e.nodeName.toUpperCase()))(n) ===
        e.toUpperCase();
      return r === t;
    },
    uR = (e) => {
      const t = MN(e.dom, e.selection.getStart());
      return y(t);
    },
    mR = (e) => cR("pre", e),
    fR = (e) => (t, n) => Vl(t) === e,
    gR = (e, t) => ((e) => aR(e, Yl(e)))(e),
    pR = (e, t) => t,
    hR = (e) => {
      const t = ql(e),
        n = MN(e.dom, e.selection.getStart());
    ...
    yR = (e, t, n) => {
      if (!t.mode.isReadOnly()) {
        if (
          ...
          C(n) && TN(t, e.fakeEventName).isDefaultPrevented())
        )
          return;
        e.insert(t, n), C(n) && AN(t, e.fakeEventName);
      }
    },
    CR = (e, t) => {
      if (e.mode.isReadOnly()) return;
        ...
        r = ((e, t) =>
          hx(
            [
              vR([lR], iR.none()),
              vR([mR(!0), uR], iR.none()),
              vR([cR("summary", !0)], iR.br()),
              vR([mR(!0), fR(!1), pR], iR.br()),
              vR([mR(!0), fR(!1)], iR.block()),
              vR([mR(!0), fR(!0), pR], iR.block()),
              vR([mR(!0), fR(!0)], iR.br()),
              vR([dR(!0), pR], iR.br()),
              vR([dR(!0)], iR.block()),
              vR([gR], iR.br()),
    ...
    wR = xt(),
    ER = wR.os.isiOS() && wR.browser.isSafari(),
    xR = (e, t) => {
      var n;
    ...
    _R = xt(),
    kR = (e) => e.stopImmediatePropagation(),
    SR = (e) => e.keyCode === yf.PAGE_UP || e.keyCode === yf.PAGE_DOWN,
    NR = (e, t, n) => {
      n && !e.get()
        ? t.on("NodeChange", kR, !0)
        : !n && e.get() && t.off("NodeChange", kR),
        e.set(n);
    },
    RR = (e, t) => {
      const n = t.container(),
    ...
    DR = (e) =>
      _c(e)
        ? [
            { keyCode: yf.TAB, action: vk(Kk, e, !0) },
            { keyCode: yf.TAB, shiftKey: !0, action: vk(Kk, e, !1) },
          ]
        : [],
    LR = (e) => {
      if ((e.addShortcut("Meta+P", "", "mcePrint"), bN(e), cw(e)))
        return Tr(null);
      {
        const t = E_(e);
        return (
          ...
          ((e) => {
            e.on("keyup compositionstart", T(ak, e));
          })(e),
          ((e, t) => {
            e.on("keydown", (n) => {
              n.isDefaultPrevented() ||
                ((e, t, n) => {
                  ...
                  yk(
                    [
                      { keyCode: yf.RIGHT, action: vk(dk, e, !0) },
                      { keyCode: yf.LEFT, action: vk(dk, e, !1) },
                      { keyCode: yf.UP, action: vk(ck, e, !1) },
                      { keyCode: yf.DOWN, action: vk(ck, e, !0) },
                      ...(o
                        ? [
                            {
                              keyCode: yf.UP,
                        ...
                        : []),
                      { keyCode: yf.RIGHT, action: vk(Hk, e, !0) },
                      { keyCode: yf.LEFT, action: vk(Hk, e, !1) },
                      { keyCode: yf.UP, action: vk($k, e, !1) },
                      { keyCode: yf.DOWN, action: vk($k, e, !0) },
                      { keyCode: yf.UP, action: vk($k, e, !1) },
                      { keyCode: yf.UP, action: vk(pk, e, !1) },
                      { keyCode: yf.DOWN, action: vk(pk, e, !0) },
                      { keyCode: yf.RIGHT, action: vk(wk, e, !0) },
                      { keyCode: yf.LEFT, action: vk(wk, e, !1) },
                      { keyCode: yf.UP, action: vk(Ek, e, !1) },
                      { keyCode: yf.DOWN, action: vk(Ek, e, !0) },
                      { keyCode: yf.RIGHT, action: vk(C_, e, t, !0) },
                      { keyCode: yf.LEFT, action: vk(C_, e, t, !1) },
                      {
                        keyCode: yf.RIGHT,
                        ctrlKey: !o,
                        altKey: o,
                      ...
                      { keyCode: yf.UP, action: vk(gk, e, !1) },
                      { keyCode: yf.DOWN, action: vk(gk, e, !0) },
                    ],
                    n
                  ).each((e) => {
                    n.preventDefault();
              ...
              (n = o.keyCode === yf.BACKSPACE),
                o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    ...
                    Ck(
                      [
                        { keyCode: yf.BACKSPACE, action: vk(Y_, e) },
                        { keyCode: yf.BACKSPACE, action: vk(JE, e, !1) },
                        { keyCode: yf.DELETE, action: vk(JE, e, !0) },
                        { keyCode: yf.BACKSPACE, action: vk(qE, e, !1) },
                        { keyCode: yf.DELETE, action: vk(qE, e, !0) },
                        { keyCode: yf.BACKSPACE, action: vk(R_, e, t, !1) },
                        { keyCode: yf.DELETE, action: vk(R_, e, t, !0) },
                        { keyCode: yf.BACKSPACE, action: vk(gb, e, !1) },
                        { keyCode: yf.DELETE, action: vk(gb, e, !0) },
                        { keyCode: yf.BACKSPACE, action: vk(NN, e, !1, s) },
                        { keyCode: yf.DELETE, action: vk(NN, e, !0, s) },
                        ...(PN
                          ? [
                              {
                                keyCode: yf.BACKSPACE,
                                altKey: !0,
                                action: vk(NN, e, !1, a(!0)),
                              },
                              {
                                keyCode: yf.DELETE,
                                altKey: !0,
                                action: vk(NN, e, !0, a(!0)),
                              },
                              {
                                keyCode: yf.BACKSPACE,
                                metaKey: !0,
                                action: vk(NN, e, !1, a(!1)),
                              },
                            ]
                          : [
                              {
                        ...
                        { keyCode: yf.BACKSPACE, action: vk(sx, e, !1) },
                        { keyCode: yf.DELETE, action: vk(sx, e, !0) },
                        { keyCode: yf.BACKSPACE, action: vk(z_, e, !1) },
                        { keyCode: yf.DELETE, action: vk(z_, e, !0) },
                        { keyCode: yf.BACKSPACE, action: vk(FE, e, !1) },
                        { keyCode: yf.DELETE, action: vk(FE, e, !0) },
                        { keyCode: yf.BACKSPACE, action: vk(LE, e, !1) },
                        { keyCode: yf.DELETE, action: vk(LE, e, !0) },
                        { keyCode: yf.BACKSPACE, action: vk(I_, e, !1) },
                        { keyCode: yf.DELETE, action: vk(I_, e, !0) },
                        { keyCode: yf.BACKSPACE, action: vk(rx, e, !1) },
                        { keyCode: yf.DELETE, action: vk(rx, e, !0) },
                      ],
                      n
                    )
                      .filter((t) => e.selection.isEditable())
                      .each((t) => {
                        n.preventDefault(),
                          TN(e, o).isDefaultPrevented() || (t(), AN(e, o));
                      });
                  })(e, t, o);
            }),
              e.on("keyup", (t) => {
                t.isDefaultPrevented() ||
                  ((e, t, n) => {
                    yk(
                      [
                        { keyCode: yf.BACKSPACE, action: vk(QE, e) },
                        { keyCode: yf.DELETE, action: vk(QE, e) },
                        ...(PN
                          ? [
                              {
                                keyCode: yf.BACKSPACE,
            ...
            e.on("keydown", (t) => {
              t.isDefaultPrevented() ||
                ((e, t) => {
                  Ck(
                    [
                      { keyCode: yf.SPACEBAR, action: vk(BR, e) },
                      { keyCode: yf.SPACEBAR, action: vk(PR, e) },
                    ],
                    t
                  ).each((n) => {
                    t.preventDefault(),
                      TN(e, "insertText", { data: " " }).isDefaultPrevented() ||
                        (n(), AN(e, "insertText", { data: " " }));
                  });
                })(e, t);
            });
          })(e),
            ...
            e.on("keydown", (n) => {
              n.isDefaultPrevented() ||
                ((e, t, n) => {
                  ...
                  yk(
                    [
                      { keyCode: yf.END, action: vk(uk, e, !0) },
                      { keyCode: yf.HOME, action: vk(uk, e, !1) },
                      ...(o
                        ? []
                        : [
                            {
                      ...
                      { keyCode: yf.END, action: vk(xk, e, !0) },
                      { keyCode: yf.HOME, action: vk(xk, e, !1) },
                      { keyCode: yf.END, action: vk(k_, e, !0, t) },
                      { keyCode: yf.HOME, action: vk(k_, e, !1, t) },
                    ],
                    n
                  ).each((e) => {
                    n.preventDefault();
              ...
              e.on("keyup", (o) => {
                o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    yk(
                      [
                        { keyCode: yf.PAGE_UP, action: vk(k_, e, !1, t) },
                        { keyCode: yf.PAGE_DOWN, action: vk(k_, e, !0, t) },
                      ],
                      n
                    );
                  })(e, t, o),
                  SR(o) && n.get() && (NR(n, e, !1), e.nodeChanged());
              });
          })(e, t),
          t
        );
  ...
  const IR = Pa("image"),
    ...
    $R =
      ...
      (e) => {
        const t = e;
        return I.from(t[FR]).exists((e) => 0 === e);
      });
  const VR = Pa("mode"),
    qR = (e) => (t) => {
      t[VR] = e;
    ...
    XR = (e) => (t) => {
      const n = t;
      return I.from(n[VR]).exists((t) => t === e);
    },
    ZR = XR(0),
    QR = XR(1),
    ...
    iA = (e) => -1 !== e.indexOf(sA),
    lA = "%MCEPASTEBIN%",
    dA = (e) => e.dom.get("mcepastebin"),
    cA = (e) => C(e) && "mcepastebin" === e.id,
    uA = (e) => e === lA,
    mA = (e, t) => (
      Dt.each(t, (t) => {
    ...
    gA = (e, t) => ({ content: e, cancelled: t }),
    pA = (e, t) => (e.insertContent(t, { merge: dc(e), paste: !0 }), !0),
    hA = (e) => /^https?:\/\/[\w\-\/+=.,!;:&%@^~(){}?#]+$/i.test(e),
    bA = (e, t, n) =>
      !(e.selection.isCollapsed() || !hA(t)) &&
      ((e, t, n) => (
        e.undoManager.extra(
          () => {
            n(e, t);
    ...
    vA = (e, t, n) =>
      !!((e, t) =>
        hA(t) && $(xc(e), (e) => Ve(t.toLowerCase(), `.${e.toLowerCase()}`)))(
        e,
        t
      ) &&
      ((e, t, n) => (
        ...
        ((e, t, n) => {
          ...
          return e.hasEventListeners("PastePostProcess") &&
            ...
            ? ((e, t, n) => {
                ...
                return gA(r.node.innerHTML, r.isDefaultPrevented());
              })(e, r, n)
            : gA(r, o.isDefaultPrevented());
        })(e, t, n))(e, t, n);
      if (!s.cancelled) {
        const t = s.content,
          n = () =>
            ((e, t, n) => {
              n || !cc(e)
                ? pA(e, t)
                : ((e, t) => {
                    Dt.each([bA, vA, pA], (n) => !n(e, t, pA));
                  })(e, t);
            })(e, t, o);
        r
          ? TN(e, "insertFromPaste", {
              dataTransfer: CA(t),
            }).isDefaultPrevented() || (n(), AN(e, "insertFromPaste"))
          : n();
      }
    },
    EA = (e, t, n, o) => {
      const r = n || iA(t);
      wA(e, ((e) => e.replace(sA, ""))(t), r, !1, o);
    },
    xA = (e, t, n) => {
    ...
    kA = (e, t) => t in e && e[t].length > 0,
    SA = (e) => kA(e, "text/html") || kA(e, "text/plain"),
    NA = (e, t, n) => {
          ...
          (s =
            kA(t, "text/plain") && i
              ...
              : ((e) => {
                  ...
                  return (e = mA(e, [/<!\[[^\]]+\]>/g])), i(n.parse(e)), o;
                })(s)),
        uA(s) || (o ? xA(e, s, r) : EA(e, s, a, r));
    },
    AA = (e, t, n) => {
      ((e, t, n) => {
        let o;
        e.on("keydown", (e) => {
          ...
          e.on("paste", (r) => {
            ...
            o = !1;
            const a = _A(r.clipboardData);
            (!SA(a) && NA(e, r, t.getLastRng() || e.selection.getRng())) ||
              (kA(a, "text/html")
                ? (r.preventDefault(), RA(e, a, a["text/html"], s, !0))
                : kA(a, "text/plain") && kA(a, "text/uri-list")
                ? (r.preventDefault(), RA(e, a, a["text/plain"], s, !0))
                : (t.create(),
                  Tg.setEditorTimeout(
                    e,
                    () => {
                      const n = t.getHtml();
                      t.remove(), RA(e, a, n, s, !1);
                    },
                    0
                  )));
          });
    ...
    BA = (e) => ({
      html: aA(e.selection.getContent({ contextual: !0 })),
    ...
    MA = /rgb\s*\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*\)/gi,
    IA = (e) => Dt.trim(e).replace(MA, Vs).toLowerCase(),
    FA = (e, t, n) => {
      const o = ic(e);
            ...
            remove: () =>
              ((e, t) => {
                ...
                if (dA(e)) {
                  let o;
                  const r = t.get();
                  for (; (o = dA(e)); ) n.remove(o), n.unbind(o);
        ...
        ((e, t) => {
          e.addCommand("mceTogglePlainTextPaste", () => {
            ...
            e.addCommand("mceInsertClipboardContent", (t, n) => {
              n.html && EA(e, n.html, n.internal, !1),
                n.text && xA(e, n.text, !1);
            });
        })(e, n),
        ((e) => {
          const t = (t) => (n) => {
          ...
          ((e) => {
            e.on(
              ...
              e.on(
                "copy",
                ((e) => (t) => {
                  !t.isDefaultPrevented() && PA(e) && TA(t, BA(e), OA(e), _);
                })(e)
              );
          })(e),
            ((e, t) => {
              nc(e) &&
                ...
                e.on("drop", (n) => {
                  ...
                  (d && !l) ||
                    (i &&
                      ...
                      Tg.setEditorTimeout(e, () => {
                        e.undoManager.transact(() => {
                          (a || (d && l)) && e.execCommand("Delete"), LA(e, o);
                          const t = fA(i);
                          r["text/html"] ? EA(e, t, s, !0) : xA(e, t, !0);
                        });
                      })));
                }),
                e.on("dragstart", (e) => {
                ...
                e.on("dragover dragend", (n) => {
                  oc(e) && !t.get() && (n.preventDefault(), LA(e, DA(e, n))),
    ...
    HA = (e) => hr(e.dom),
    $A = (e) => (t) => kn(Cn(e), t),
    VA = (e, t) => Zn(Cn(e), HA, $A(t)),
    qA = (e, t, n) => {
      const o = new Ho(e, t),
        r = n ? o.next.bind(o) : o.prev.bind(o);
      let s = e;
      for (let t = n ? e : r(); t && !zA(t); t = r()) Bi(t) && (s = t);
      return s;
    },
    WA = (e) => {
      const t = ((e, t, n) => {
        ...
        return (
          VA(s, r).fold(
            () => {
              jA(s) ? i.setStart(s, 0) : i.setStartBefore(s);
            },
            (e) => i.setStartBefore(e.dom)
          ),
          VA(a, r).fold(
            () => {
              jA(a) ? i.setEnd(a, a.data.length) : i.setEndAfter(a);
            },
  ...
  const YA = (e, t) => Math.abs(e.left - t),
    GA = (e, t) => Math.abs(e.right - t),
    XA = (e, t) =>
      ((e) =>
        X(
          e,
    ...
    JA = (e, t, n) =>
      ((e, t, n) => {
        ...
        return ((e, t, n, o) => {
          const r = (t, s) => {
            ...
            return s
              ...
              .orThunk(() =>
                (kn(t, e) ? I.none() : On(t)).bind((e) => r(e, I.some(t)))
              );
          };
          return r(t, I.none());
        })(o, s, t, n);
        ...
        .map((e) =>
          ((e, t) => ({
            node: e.node,
            position: YA(e, t) < GA(e, t) ? KA.Before : KA.After,
          }))(e, t)
        ),
    eT = (e) => {
      var t, n;
    ...
    nT = (e, t, n, o) => {
      ...
      return v(o)
        ...
        : ((e, t, n, o) => ({ ...t, dataTransfer: o, type: e, ...tT(n) }))(
            e,
            o,
            t,
            r
    ...
    mT = (e, t, n, o, r) => {
      "dragstart" === t && nA(o, e.dom.getOuterHTML(n));
      const s = nT(t, n, o, r);
    ...
    fT = (e, t) => {
      ...
      return (r) =>
        e.on((e) => {
          ...
          if (!e.dragging && s > 10) {
            const n = mT(t, "dragstart", e.element, e.dataTransfer, r);
            if (
            ...
            const s = r.currentTarget === t.getDoc().documentElement,
              l = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(
                ...
                ((e, t) => {
                  return (
                    (n = ((e) =>
                      e.inline ? eT(e.getBody()) : { left: 0, top: 0 })(e)),
                    (o = ((e) => {
                      const t = e.getBody();
                      return e.inline
                    ...
                    (r = ((e, t) => {
                      if (t.target.ownerDocument !== e.getDoc()) {
                        const n = eT(e.getContentAreaContainer()),
                          o = ((e) => {
                            const t = e.getBody(),
                  ...
                  e.intervalId.clear(),
                    e.dragging &&
                      ...
                      (a + 8 >= g
                        ...
                        : a - 8 <= 0
                        ? e.intervalId.set(dT(d))
                        : i + 8 >= p
                        ? e.intervalId.set(lT(d))
                        : i - 8 <= 0
                        ? e.intervalId.set(iT(d))
                        : h + 16 >= window.innerHeight
                        ? e.intervalId.set(cT(window))
                        : h - 16 <= 0
                        ? e.intervalId.set(dT(window))
                        : b + 16 >= window.innerWidth
                        ? e.intervalId.set(lT(window))
                        : b - 16 <= 0 && e.intervalId.set(iT(window)));
                });
              })(
                e.ghost,
                l,
    ...
    gT = (e, t, n) => {
      e.on((e) => {
        e.intervalId.clear(),
          e.dragging &&
            n.fold(
              () => mT(t, "dragend", e.element, e.dataTransfer),
              (n) => mT(t, "dragend", e.element, e.dataTransfer, n)
            );
      }),
        pT(e);
    },
    ...
    hT = (e) => {
      const t = Br(),
        ...
        r = ((e, t) => (n) => {
          if (((e) => 0 === e.button)(n)) {
            const o = Q(t.dom.getParents(n.target), rT).getOr(null);
            if (
              C(o) &&
              ((e, t, n) => oT(n) && n !== t && e.isEditable(n.parentElement))(
                t.dom,
                t.getBody(),
                o
              )
              ...
              e.set({
                ...
                ghost: sT(t, o, o.offsetWidth, o.offsetHeight),
                intervalId: Or(100),
              });
            }
          }
        ...
        a = ((e, t) => (n) => {
          e.on((e) => {
            ...
            if ((e.intervalId.clear(), e.dragging)) {
              if (
                ...
                const r =
                  ...
                  void 0 !== o
                    ? o
                    : t.getBody();
                mT(t, "drop", r, e.dataTransfer, n).isDefaultPrevented() ||
                  t.undoManager.transact(() => {
                    ((e, t) => {
              ...
              mT(t, "dragend", t.getBody(), e.dataTransfer, n);
            }
          }),
            pT(e);
        })(t, e),
      ...
      e.on("mousedown", r),
        ...
        e.on("keydown", (n) => {
          n.keyCode === yf.ESC && gT(t, e, I.none());
        });
    },
    bT = hr,
    vT = (e, t) => pb(e.getBody(), t),
    yT = (e) => {
      const t = e.selection,
        n = e.dom,
        o = e.getBody(),
      ...
      return (
        cw(e) ||
          ...
          e.on(
            ...
            (t) => {
              const n = t.target,
                o = vT(e, n);
              bT(o)
                ? (t.preventDefault(), zE(e, o).each(f))
                : l(n) && zE(e, n).each(f);
            },
            !0
          ),
          e.on("mousedown", (r) => {
              ...
              !((e, t, n) => {
                const o = Cn(e.getBody()),
                  ...
                  s = ((e, t, n, o) => {
                    ...
                    return {
                      x: n - (e ? r.left + t.dom.clientLeft + $w(t) : 0),
                      y: o - (e ? r.top + t.dom.clientTop + Hw(t) : 0),
                    };
                  })(e.inline, r, t, n);
                return ((e, t, n) => {
                  const o = zw(e),
            ...
            const a = vT(e, s);
            bT(a)
              ? (r.preventDefault(), zE(e, a).each(f))
              : JA(o, r.clientX, r.clientY).each((n) => {
                  var o;
                  r.preventDefault(),
                    (o = d(1, n.node, n.position === KA.Before, !1)) &&
                      t.setRng(o),
                    Jo(a) ? a.focus() : e.getBody().focus();
                });
          }),
          e.on("keypress", (e) => {
            yf.modifierPressed(e) || (bT(t.getNode()) && e.preventDefault());
          }),
                  ...
                  const t = (t) => {
                      if (!t.isDefaultPrevented()) {
                        ...
                        n &&
                          ...
                          (t.preventDefault(),
                          "drop" === t.type &&
                            Gw(e, "Dropped file type is not supported"));
                      }
                    },
                    n = (n) => {
                      Dg(e, n.target) && t(n);
              ...
              e.on("focusin", (t) => {
                ...
                if (yr(n)) {
                  ...
                  e.selection.getNode() !== o &&
                    zE(e, o).each((t) => e.selection.setRng(t));
                }
              });
            });
          })(e)),
    ...
    _T = (e, t) =>
      xT(e, t.start).bind(({ node: n, offset: o }) =>
        xT(e, t.end).map(({ node: e, offset: t }) => {
          const r = document.createRange();
    ...
    kT = (e, t, n) => {
      if (t && e.isEmpty(t) && !n(t)) {
        const o = t.parentNode;
        e.remove(t, ir(t.firstChild) && Ko(t.firstChild.data)), kT(e, o, n);
      }
    },
    ST = (e, t, n, o = !0) => {
    ...
    NT = (e, t) => I.from(e.dom.getParent(t.startContainer, e.dom.isBlock)),
    RT = (e, t, n) => {
    ...
    TT = (e, t) => e.create("span", { "data-mce-type": "bookmark", id: t }),
    OT = (e, t) => {
      const n = e.createRng();
      return n.setStartAfter(t.start), n.setEndBefore(t.end), n;
    },
    BT = (e, t, n) => {
      const o = _T(e.getRoot(), n).getOrDie("Unable to resolve path range"),
        r = o.startContainer,
        s = o.endContainer,
      ...
      return {
        prefix: t,
        end: a.parentNode.insertBefore(TT(e, t + "-end"), a),
        start: l.insertBefore(TT(e, t + "-start"), i),
      };
    },
    PT = (e, t, n) => {
      kT(e, e.get(t.prefix + "-end"), n), kT(e, e.get(t.prefix + "-start"), n);
    },
    DT = (e) => 0 === e.start.length,
    LT = (e, t, n, o) => {
      const r = t.start;
      var s;
      return eS(
        ...
        }
        {
          ...
          return Qk(o.container, s, n)
            ...
            .orThunk(() => LT(e, t, n, Yk(o.container, 0)));
        }
      });
    },
    MT = (e, t, n, o) => {
      const r = e.dom,
        ...
        l = n.position.offset;
      return Qk(i, l - n.pattern.end.length, t).bind((d) => {
        const c = ET(r, s, d.container, d.offset, i, l, o);
        if (DT(a))
          return I.some({
        ...
        {
          const i = IT(e, n.remainingPatterns, d.container, d.offset, t, o),
          ...
          return m.map((e) => {
            ...
            return {
              ...
              position: Yk(e.startContainer, e.startOffset),
            };
          });
        }
      });
    ...
    IT = (e, t, n, o, r, s) => {
      ...
      return Zk(n, o, a.getRoot()).bind((i) => {
        ...
        for (let a = 0; a < t.length; a++) {
          ...
          if (u.isNone() && o > 0) return IT(e, t, n, o - 1, r, s);
    ...
    UT = (e, t, n, o, r, s) => {
      ...
      return ((e, t) => {
        ...
        IT(e, r.inlinePatterns, n, o, t, s).fold(
          () => [],
          (e) => e.matches
        ),
        IT(
    ...
    zT = (e, t) => {
        ...
        r = ((e, t) => {
          const n = Pa("mce_textpattern"),
            o = G(
              t,
              (t, o) => {
                const r = BT(e, n + `_end${t.length}`, o.endRng);
      ...
      q(r, (t) => {
        ...
        DT(t.pattern)
          ...
          PT(n, t.endMarker, r),
          PT(n, t.startMarker, r);
      }),
        e.selection.moveToBookmark(o);
    },
    jT = (e, t, n) =>
      ((e, t, n) => {
        if (ir(e) && 0 >= e.length) return I.some(Yk(e, 0));
        {
          const t = Fa(Gk);
          return I.from(t.forwards(e, 0, Xk(e), n)).map((e) =>
            Yk(e.container, 0)
          );
        }
      })(t, 0, t).map((o) => {
    ...
    HT = (e) => (t, n) => {
      const o = t.dom,
        r = n.pattern,
        s = _T(o.getRoot(), n.range).getOrDie("Unable to resolve path range");
      return (
        NT(t, s).each((n) => {
          "block-format" === r.type
            ? ((e, t) => {
        ...
        ? e(r.blockPatterns, a)
            .map((e) =>
              t && Dt.trim(a).length === e.start.length
                ? []
                : [{ pattern: e, range: ET(l, l.getRoot(), o, 0, o, 0, s) }]
            )
            .getOr([])
        : [];
    },
    ...
    WT = $T((e, t, n) => 0 === t.indexOf(e.start) || 0 === n.indexOf(e.start)),
    KT = VT(WT, !0),
    YT = HT(jT),
    GT = $T((e, t, n) => t === e.start || n === e.start),
    XT = VT(GT, !1),
    ZT = (e, t, n) => {
    ...
    QT = (e) => {
                ...
                ((e, t) => {
                  ...
                  return NT(e, n)
                    .map((o) => {
                      ...
                      return {
                        inlineMatches: UT(e, o, n.startContainer, s, a, !0),
                        blockMatches: KT(e, o, a, !0),
                      };
                    })
                    .filter(
                    ...
                    return NT(e, n)
                      .map((o) => {
                        const r = Math.max(0, n.startOffset),
                          s = AT(e.dom, o, n.startContainer, r),
                          a = RT(t, o, s);
                        return XT(e, o, a, !1, s);
                      })
                      .filter((e) => e.length > 0);
            ...
            ((e, t) => {
              ...
              NT(e, n).map((o) => {
                const r = Math.max(0, n.startOffset - 1),
                  s = AT(e.dom, o, n.startContainer, r),
                  a = RT(t, o, s),
                  i = UT(e, o, n.startContainer, r, a, !1);
                i.length > 0 &&
                  e.undoManager.transact(() => {
                    zT(e, i);
                  });
      ...
      e.on("keyup", (e) => {
        ZT(n, e, (e, t) => e === t.keyCode && !yf.modifierPressed(t)) && s();
      }),
        e.on("keypress", (n) => {
          ZT(t, n, (e, t) => e.charCodeAt(0) === t.charCode) &&
    ...
    eO = ca.DOM,
    tO = (e) => (e.inline ? e.getElement().nodeName.toLowerCase() : void 0),
    nO = (e) => Ce(e, (e) => !1 === v(e)),
    oO = (e) => {
    ...
    sO = (e) => (e.inline ? e.ui.styleSheetLoader : e.dom.styleSheetLoader),
    aO = (e) => {
      const t = sO(e),
        n = pd(e),
        o = e.contentCSS,
      ...
      const a = Promise.all(
          ((e, t, n) => {
            const { pass: o, fail: r } = K(t, (e) =>
                tinymce.Resource.has(Jw(e))
              ),
              s = o.map((t) => {
                const n = tinymce.Resource.get(Jw(t));
                return m(n)
                  ? Promise.resolve(sO(e).loadRawCss(t, n))
                  : Promise.resolve();
              }),
              a = [...s, sO(e).loadAll(r)];
    ...
    iO = (e) => {
      !0 !== e.removed &&
        (((e) => {
          cw(e) || e.load({ initial: !0, format: "html" }),
    ...
    lO = (e) => {
      ...
      let n = e.getDoc();
      e.inline &&
        (eO.addClass(t, "mce-content-body"),
      ...
      (o.disabled = !0),
        ...
        e.hasEditableRoot() &&
          (e.inline &&
            "static" === eO.getStyle(o, "position", !0) &&
        ...
        (e.selection = vw(e.dom, e.getWin(), e.serializer, e)),
        (e.annotator = df(e)),
        (e.formatter = vE(e)),
        (e.undoManager = CE(e)),
        (e._nodeChangeDispatcher = new MR(e)),
        (e._selectionOverrides = yT(e)),
        ((e) => {
          const t = Br(),
            n = Tr(!1),
            o = ya((t) => {
            ...
            e.on("BeforeSetContent", (t) => {
              ((e, t, n) => {
                let o = t.length,
                  r = n.content;
                if ("raw" !== n.format) {
                  for (; o--; ) r = r.replace(t[o], ok(e, r, hc(e)));
                  n.content = r;
                }
              })(e, a, t);
            }),
        ...
        cw(e) ||
          (((e) => {
            e.on("mousedown", (t) => {
              t.detail >= 3 && (t.preventDefault(), WA(e));
            });
          })(e),
          ((e) => {
            QT(e);
          ...
          e.on("NodeChange", () =>
            ((e) => {
              ...
              if (
                ...
                ((e, t, n) => $(Up(Cn(n), Cn(t)), (t) => Z_(e, t.dom)))(r, a, s)
              )
                return;
              ...
              for (; m; )
                if ((Qo(m) && qr(o, m), Q_(o, m))) {
                  ...
                  if (!i) {
                    ...
                    (i = ek(e)), a.insertBefore(i, m);
                  }
                  (l = m), (m = m.nextSibling), i.appendChild(l);
                } else (i = null), (m = m.nextSibling);
              d && (e.selection.setRng(ox(d)), e.nodeChanged());
            })(e)
          );
        })(e),
        ((e) => {
            ...
            s = (t, a) => {
              ...
              const i = e.getBody(),
                l =
                  !((e) =>
                    xE(e) &&
                    !(_E(e) || ("keyup" === e.type && 229 === e.keyCode)))(t) &&
                  ((e, t, n) => {
                    if (
              ...
              (("" !== n.getAttrib(i, EE)) !== l || a) &&
                (n.setAttrib(i, EE, l ? r : null),
                ((e, t) => {
      ...
      ((e) => {
        ...
        ((e) => {
          ...
          ec(e) ||
            ((t.body.spellcheck = !1), eO.setAttrib(n, "spellcheck", "false")),
          (e.quirks = JT(e)),
          ((e) => {
          ...
          (t) => {
            e.setProgressState(!0),
              aO(e).then(() => {
                t().then(
                  (t) => {
                    e.setProgressState(!1), iO(e), fw(e);
                  },
                  (t) => {
                    e.notificationManager.open({
                      type: "error",
    ...
    cO = ca.DOM,
    uO = ca.DOM,
    mO = (e, t) => ({ editorContainer: e, iframeContainer: t, api: {} }),
    fO = (e) => {
      const t = e.getElement();
      return e.inline
        ? mO(null)
        : ((e) => {
            const t = uO.create("div");
            return uO.insertAfter(t, e), mO(t, t);
          })(t);
    },
    gO = async (e) => {
      e.dispatch("ScriptsLoaded"),
        ((e) => {
          const t = Dt.trim(td(e)),
            ...
            o = { ...Mw.get("default").icons, ...Mw.get(t).icons };
          pe(o, (t, o) => {
        ...
        ((e) => {
          ...
          if (m(t)) {
            const n = Ww.get(t);
            (e.theme = n(e, Ww.urls[t]) || {}),
              w(e.theme.init) &&
                e.theme.init(
                  e,
                  Ww.urls[t] || e.documentBaseUrl.replace(/\/$/, "")
                );
          } else e.theme = {};
        })(e),
        ((e) => {
        ...
        ((e) => {
          ...
          q($d(e), (n) => {
            ((e, t, n) => {
              const o = qw.get(n),
                r = qw.urls[n] || e.documentBaseUrl.replace(/\/$/, "");
              ...
              ((e, t) => {
                ...
                ((e) => {
                  const t = e.iframeElement,
                    n = () => {
                      (e.contentDocument = t.contentDocument), lO(e);
                    };
    ...
    vO = (e, t) => {
      ...
      ((e, t) => {
        ...
        if (m(n) && !hO(n) && !_e(Ww.urls, n)) {
          ...
          Ww.load(n, r).catch(() => {
            ((e, t, n) => {
              Xw(e, "ThemeLoadError", Zw("theme", t, n));
            })(e, r, n);
          });
        }
      })(e, t),
        ((e, t) => {
          ...
          if ("plugin" !== n && !_e(Iw.urls, n)) {
            ...
            Iw.load(n, r).catch(() => {
              ((e, t, n) => {
                Xw(e, "ModelLoadError", Zw("model", t, n));
              })(e, r, n);
            });
          }
        })(e, t),
        ((e, t) => {
          ...
          if (!ha.hasCode(n) && "en" !== n) {
            ...
            e.add(r).catch(() => {
              ((e, t, n) => {
                Xw(e, "LanguageLoadError", Zw("language", t, n));
              })(t, r, n);
            });
          }
        })(n, e),
        ((e, t, n) => {
          ...
          q(
            ...
            (n) => {
              e.add(n.url).catch(() => {
                ((e, t, n) => {
                  Xw(e, "IconsLoadError", Zw("icons", t, n));
        ...
        ((e, t) => {
          const n = (t, n) => {
            qw.load(t, n).catch(() => {
              ((e, t, n) => {
                Xw(e, "PluginLoadError", Zw("plugin", t, n));
              })(e, n, t);
            });
          };
          pe(Vd(e), (t, o) => {
    ...
    NO = (e, t, n, o, r) => {
      var s;
      const a = e
          ? { mobile: kO(null !== (s = r.mobile) && void 0 !== s ? s : {}, t) }
          : {},
        i = xO(["mobile"], hS(a, r)),
        l = Dt.extend(
          n,
          ...
          ((e, t) => e && _O(t, "mobile"))(e, i)
            ...
            : {},
          { external_plugins: SO(o, i.options()) }
        );
      return ((e, t, n, o) => {
    ...
    TO = (e, t) => {
      if (e.selection.isEditable()) {
        ...
        LC(e, {
          ...
          const n = ((e, t, n) => uw(e).editor.insertContent(t, n))(
            e,
            t.content,
            o
          );
          MC(e, n, t), e.addVisual();
        });
      }
    },
    OO = { "font-size": "size", "font-family": "face" },
    BO = Zt("font"),
    PO = (e) => (t, n) =>
      I.from(n)
        .map(Cn)
          ...
          ((e, t, n) =>
            Hb(
              ...
              (t) =>
                ((t) =>
                  uo(t, e).orThunk(() =>
                    BO(t) ? xe(OO, e).bind((e) => nn(t, e)) : I.none()
                  ))(t),
              (e) => kn(Cn(t), e)
            ))(e, t, n.dom).or(
      ...
      RO(e),
        ...
        ((e) => {
          e.editorCommands.addCommands({
            ...
            e.editorCommands.addCommands({ Outdent: () => $_(e) }, "state");
        })(e),
        ((e) => {
          e.editorCommands.addCommands({
          ...
          ((e) => {
            ...
            e.editorCommands.addCommands({
              ...
              FontName: (t, n, o) => {
                ((e, t) => {
                  const n = FO(e, t);
                  e.formatter.toggle("fontname", { value: UO(n) }),
                    e.nodeChanged();
                })(e, o);
              },
              FontSize: (t, n, o) => {
                ((e, t) => {
                  e.formatter.toggle("fontsize", { value: FO(e, t) }),
                    e.nodeChanged();
                })(e, o);
              },
              LineHeight: (t, n, o) => {
            ...
            ((e) => {
              ...
              e.editorCommands.addCommands(
                ...
                e.editorCommands.addQueryValueHandler("FontName", () =>
                  ((e) => IO(e, (t) => LO(e.getBody(), t.dom)).getOr(""))(e)
                ),
                e.editorCommands.addQueryValueHandler("FontSize", () =>
                  ((e) => IO(e, (t) => DO(e.getBody(), t.dom)).getOr(""))(e)
                ),
                e.editorCommands.addQueryValueHandler("LineHeight", () =>
                  ((e) =>
                    IO(e, (t) => {
                      const n = Cn(e.getBody()),
                        o = Hb(t, (e) => uo(e, "line-height"), T(kn, n));
                      return o.getOrThunk(() => {
  ...
  class VO {
    ...
    queryCommandState(e) {
      if ((!$O(e) && this.editor.quirks.isHidden()) || this.editor.removed)
        return !1;
      const t = e.toLowerCase(),
      ...
      ((e, t, n) => {
        ...
        t
          ? (((e) => {
            ...
            e.hasEditableRoot() && WO(n, !0))
          : ((e, t) => {
              (e.readonly = !1),
                e.hasEditableRoot() && WO(t, !0),
                ((e, t) => {
                  qO(e, "StyleWithCSS", t),
                    qO(e, "enableInlineTableEditing", t),
                    qO(e, "enableObjectResizing", t);
                })(e, !1),
                jg(e) && e.focus(),
                ((e) => {
                  e.selection.setRng(e.selection.getRng());
  ...
  const QO = (e) => (
    ...
    JO = {
      ...
      on(e, t, n) {
        return QO(this).on(e, t, n);
      },
      off(e, t) {
        return QO(this).off(e, t);
      },
      once(e, t) {
        return QO(this).once(e, t);
      },
      hasEventListeners(e) {
        return QO(this).has(e);
      },
    },
    eB = ca.DOM;
  let tB;
  const nB = (e, t) => {
      ...
      const n = wd(e);
      return n
        ? (e.eventRoot || (e.eventRoot = eB.select(n)[0]), e.eventRoot)
        : e.getBody();
    },
    oB = (e, t, n) => {
      ((e) => !e.hidden)(e)
        ...
        : YO(e) &&
          ((e, t) => {
            if (((e) => "click" === e.type)(t) && !yf.metaKeyPressed(t)) {
              const n = Cn(t.target);
              ((e, t) =>
                to(t, "a", (t) => kn(t, Cn(e.getBody()))).bind((e) =>
                  nn(e, "href")
                ))(e, n).each((n) => {
            ...
            } else ((e) => H(GO, e.type))(t) && e.dispatch(t.type, t);
          })(e, n);
    },
    rB = (e, t) => {
      ...
      if (wd(e)) {
        ...
        const o = (n) => {
          ...
          for (; s--; ) {
            const e = r[s].getBody();
            (e === o || eB.isChildOf(o, e)) && oB(r[s], t, n);
          }
        };
        (tB[t] = o), eB.bind(n, t, o);
      } else {
        const o = (n) => {
          oB(e, t, n);
        };
        eB.bind(n, t, o), (e.delegates[t] = o);
      }
    },
    sB = {
      ...JO,
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                n.delegates &&
                (n.dom.unbind(nB(n, e), e, n.delegates[e]),
    ...
    iB = (e, t) => e + (Xe(t.message) ? "" : `. ${t.message}`),
    lB = (e) => e.valid,
    dB = (e, t, n = "") => {
      const o = t(e);
      return b(o)
    ...
    uB = (e, t, n, o) => {
      ...
      r.deactivate(),
        r.editorReadOnly !== s.editorReadOnly && KO(e, s.editorReadOnly),
        t.set(o),
        ((e, t) => {
    ...
    pB = Dt.makeMap("alt,ctrl,shift,meta,access"),
    hB = (e) => {
      const t = {},
        n = Tt.os.isMacOS() || Tt.os.isiOS();
      mB(fB(e.toLowerCase(), "+"), (e) => {
        ((e) => e in pB)(e)
          ? (t[e] = !0)
          : /^[0-9]{2,}$/.test(e)
          ? (t.keyCode = parseInt(e, 10))
          : ((t.charCode = e.charCodeAt(0)),
            (t.keyCode = gB[e] || e.toUpperCase().charCodeAt(0)));
      });
      const o = [t.keyCode];
      let r;
      for (r in pB) t[r] ? o.push(r) : (t[r] = !1);
      return (
        (t.id = o.join(",")),
  ...
  const vB = () => {
      const e = (() => {
        ...
        return {
          ...
          addContextForm: d(s, "contextform"),
  ...
  class EB {
    constructor(e, t, n) {
        ...
        const o = {},
          ...
          s = (e, t, n) => {
            ...
            return lB(o)
              ? ((r[e] = o.value), !0)
              : (console.warn(
                  iB(`Invalid value passed for the ${e} option`, o)
                ),
                !1);
          },
          a = (e) => _e(o, e);
          ...
          register: (e, n) => {
            const a = ((e) => m(e.processor))(n)
                ? ((e) => {
                    ...
                    return (n) => dB(n, t, `The value must be a ${e}.`);
                  })(n.processor)
                : n.processor,
              i = ((e, t, n) => {
                if (!v(t)) {
                  const o = dB(t, n);
                  if (lB(o)) return o.value;
                  console.error(
                    iB(`Invalid default value passed for the "${e}" option`, o)
                  );
                }
              })(e, n.default, a);
      ...
      C(d) && ca.DOM.styleSheetLoader._setContentCssCors(d),
        ...
        this.setDirty(!1),
        (this.documentBaseURI = new hC(zl(o), { base_uri: this.baseUri })),
        (this.baseURI = this.baseUri),
        (this.inline = Pd(o)),
        (this.hasVisual = Wd(o)),
        (this.shortcuts = new bB(this)),
        (this.editorCommands = new VO(this)),
        jO(this);
    ...
    render() {
      ((e) => {
        ...
        ha.setCode(dd(e));
        const n = () => {
          pO.unbind(window, "ready", n), e.render();
        };
        if (!ea.Event.domLoaded) return void pO.bind(window, "ready", n);
        ...
        s &&
          ...
          Dd(e) &&
            !ar(e.getElement()) &&
            (pO.insertAfter(pO.create("input", { type: "hidden", name: t }), t),
            (e.hasHiddenInput = !0)),
          ...
          (e.windowManager = Kw(e)),
          (e.notificationManager = Vw(e)),
    ...
    hasPlugin(e, t) {
      return !(!H($d(this), e) || (t && void 0 === qw.get(e)));
    }
    nodeChanged(e) {
    ...
    show() {
      ...
      e.hidden &&
        ...
        e.inline
          ...
          : (yB.show(e.getContainer()), yB.hide(e.id)),
        e.load(),
        e.dispatch("show"));
    }
    hide() {
      ...
      e.hidden ||
        ...
        e.inline
          ...
          : (yB.hide(e.getContainer()),
            yB.setStyle(e.id, "display", e.orgDisplay)),
        (e.hidden = !0),
        e.dispatch("hide"));
    }
    isHidden() {
    ...
    save(e = {}) {
      ...
      if (
        ...
        const o = yB.getParent(t.id, "form");
        o && wB(o.elements, (e) => e.name !== t.id || ((e.value = r), !1));
      }
      return (
    ...
    getContent(e) {
      return ((e, t = {}) => {
        ...
        return PC(e, n).fold(R, (t) => {
          const n = ((e, t) => uw(e).editor.getContent(t))(e, t);
          return DC(e, n, t);
        });
      })(this, e);
    }
    ...
    resetContent(e) {
      void 0 === e
        ? Ew(this, this.startContent, { format: "raw" })
        : Ew(this, e),
    ...
    getContainer() {
      ...
      return (
        e.container ||
          (e.container = e.editorContainer || yB.get(e.id + "_parent")),
        e.container
      );
    }
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = yB.get(this.id)), this.targetElm
      );
    }
    getWin() {
      const e = this;
        ...
        if (!e.removed) {
          ...
          o && e.save({ is_removing: !0 }),
            ...
            !e.inline &&
              o &&
              ((e) => {
                Dw.setStyle(e.id, "display", e.orgDisplay);
              })(e),
            ((e) => {
              e.dispatch("detach");
            })(e),
            Dw.remove(e.getContainer()),
            Lw(t),
            Lw(n),
            e.destroy();
        }
            ...
            ? (t ||
              ...
              ((e) => {
                ...
                t &&
                  ...
                  Dw.unbind(t, "submit reset", e.formEventDelegate));
              })(e),
              ((e) => {
                const t = e;
  ...
  const RB = (e) => {
    ...
    AB = (e) => {
      if (e !== SB) {
        const t = ca.DOM;
        e
          ? (t.bind(window, "resize", RB), t.bind(window, "scroll", RB))
          : (t.unbind(window, "resize", RB), t.unbind(window, "scroll", RB)),
          (SB = e);
      }
    },
    TB = (e) => {
      ...
      return (
        (NB = Y(NB, (t) => e !== t)),
        BB.activeEditor === e &&
          (BB.activeEditor = NB.length > 0 ? NB[0] : null),
        BB.focusedEditor === e && (BB.focusedEditor = null),
        t.length !== NB.length
      );
    },
    ...
    BB = {
      ...
      setup() {
        ...
        let t = "",
          n = "",
          o = hC.getDocumentBaseUrl(document.location);
        /^[^:]+:\/\/\/?[^\/]+\//.test(o) &&
          ((o = o.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, "")),
          /[\/\\]$/.test(o) || (o += "/"));
        ...
        var s;
        (e.baseURL = new hC(o).toAbsolute(t)),
          (e.documentBaseURL = o),
          (e.baseURI = new hC(e.baseURL)),
          (e.suffix = n),
        ...
        return (
          n === e ||
            ...
            kB ||
              ...
              window.addEventListener("beforeunload", kB))),
          e
        );
      },
      createEditor(e, t) {
        return this.add(new EB(e, t, this));
      },
      remove(e) {
        const t = this;
        let n;
        if (e) {
          if (!m(e))
            return (
              ...
              h(t.get(n.id))
                ? null
                : (TB(n) && t.dispatch("RemoveEditor", { editor: n }),
                  0 === NB.length &&
                    window.removeEventListener("beforeunload", kB),
                  n.remove(),
                  AB(NB.length > 0),
                  n)
            );
        ...
        } else for (let e = NB.length - 1; e >= 0; e--) t.remove(NB[e]);
      },
      execCommand(e, t, n) {
        var o;
        const r = this,
      ...
      _setBaseUrl(e) {
        (this.baseURL = new hC(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, "")
        )),
          (this.baseURI = new hC(this.baseURL));
      },
    };
  BB.setup();
  const PB = (() => {
    ...
    FB = (e, t, n, o) => ({ x: e, y: t, w: n, h: o }),
    UB = {
      inflate: (e, t, n) => FB(e.x - t, e.y - n, e.w + 2 * t, e.h + 2 * n),
      relativePosition: IB,
      ...
      intersect: (e, t) => {
        const n = LB(e.x, t.x),
          o = LB(e.y, t.y),
          r = DB(e.x + e.w, t.x + t.w),
          s = DB(e.y + e.h, t.y + t.h);
        return r - n < 0 || s - o < 0 ? null : FB(n, o, r - n, s - o);
      },
      clamp: (e, t, n) => {
        let o = e.x,
          r = e.y,
      ...
      create: FB,
      fromClientRect: (e) => FB(e.left, e.top, e.width, e.height),
    },
    zB = (() => {
      const e = {},
        t = {},
  ...
  try {
    ...
    (jB = window.localStorage), jB.setItem(e, e), jB.removeItem(e);
  } catch (e) {
    jB = (() => {
      let e = {},
        t = [];
  ...
  const HB = {
      ...
      util: {
        ...
        ImageUploader: (e) => {
          const t = nE(),
            n = aE(e, t);
          return { upload: (t, o = !0) => n.upload(t, o ? sE(e) : void 0) };
        },
      },
      dom: {
        EventUtils: ea,
...
!(function () {
  ...
  function G(a) {
    return function () {
      ...
      for (var r, e, o = {}, i = 0; i < n.length; i++) {
        var u,
          c = n[i];
        for (u in c) (r = c), (e = u), cn.call(r, e) && (o[u] = a(o[u], c[u]));
      }
      return o;
    };
  }
  function z(n, t) {
    var n = ln(n, t),
      ...
      e =
        ...
        sn(o, n)),
      n = 0 === un(e).length ? {} : { external_plugins: e };
    return sn(t, n);
  }
  function S(n) {
  ...
  function H(n, t) {
    C(t, ".tox-notifications-container", "block"),
      D(n, "6.0.0") && C(t, ".tox-notification", "-ms-grid"),
    ...
    tn = t(Z, function (c) {
      c.on("AddEditor", function (n) {
        var t,
          ...
          o,
          i = n.editor,
          u = j(c).fluffy_account_message_url;
        a(u) &&
          ((r = "focus"),
          (e = function () {
            var t, r, n;
            (t = c),
                        ...
                        switch (n.label) {
                          case 0:
                            return r.ok
                              ...
                              : [3, 6];
                          case 1:
                            return n.trys.push([1, 3, , 4]), [4, r.json()];
                          case 2:
                            return (
                              (t = n.sent()),
                          ...
                          case 4:
                            return [
                              2,
                              M.error("failed to parse JSON response"),
                            ];
                          case 5:
                            return [3, 7];
                          case 6:
              ...
              P.then(function (n) {
                n.fold(
                  function (n) {
                    return I(t, "Error in TinyMCE cloud startup: ".concat(n));
                  },
                  function (n) {
                    return n.each(function (n) {
                      I(t, n.console_message), Y(r, n.service_message);
                    });
                  }
                );
              });
      ...
      T(n, function (n) {
        ...
        "none" === window.getComputedStyle(n).display &&
          ...
          (n = e).theme &&
            ...
            f(n.theme.getNotificationManagerImpl) &&
              f(n.theme.getNotificationManagerImpl().reposition) &&
...
(function tcsl(cloudSettings, consoleMessage, forceReadOnly) {
...
})(
  {
    ...
    chiffer_cdp_init_service_url:
      "https://cdn.tiny.cloud/1/no-origin/tinymce/7.5.1-116/cdn-init",
...
tinymce.baseURL = "https://cdn.tiny.cloud/1/no-origin/tinymce/7.5.1-116";
...
!(function () {
  ...
  function S(i, c) {
    return function (n) {
      ...
      return (
        a(e)
          ? (e.isSet(i) ? D.from(e.get(i)) : D.none()).bind(t)
          : o(n.getParam(i))
      ).getOr(r);
    };
  }
      ...
      r =
        ...
        l(r.os) &&
          (o = {
            ...
            version:
              null == (c = r.browser.version) ? void 0 : c.major.toString(),
          }),
  ...
  var G,
    ...
    R = L(s),
    V = L(c),
    vn = S("inline", { processor: D.some, legacyProcessor: V }),
    hn = S("readonly", { processor: D.some, legacyProcessor: V }),
    wn = S("resize", { processor: O, legacyProcessor: O }),
    bn = S("icons", { processor: k, legacyProcessor: k }),
    _n = S("theme", { processor: k, legacyProcessor: k }),
    Sn = S("skin", { processor: k, legacyProcessor: k }),
    kn = S("language", { processor: k, legacyProcessor: k }),
    On = S("toolbar_mode", { processor: D.some, legacyProcessor: R }),
    In = S("toolbar_location", { processor: R, legacyProcessor: R }),
    Pn = S("ui_mode", { processor: R, legacyProcessor: D.none }),
    xn = S("height", { processor: O, legacyProcessor: O }),
    Tn = function (n, e) {
      if (f(window.fetch))
        try {
          var t = {
    ...
    jn = { direct: !1, library: { name: "chiffer", version: "3.4.0-26" } },
    An = function (n, e, t) {
      (t = J(jn, t)), (n = Z(n, e));
      return {
    ...
    Vn = function (a, u) {
      return {
        send: function (n, e, t) {
          ...
          s(e)
            ? (((o = document.createElement("img")).src = e + r),
              (o.onload = (i = function (n) {
                return function () {
                  (o.onload = null), (o.onerror = null), t(n);
                };
              })(!0)),
              (o.onerror = i(!1)))
            : t(!1);
    ...
    (A = u(j)
      ...
      : ((T = (function (n, e) {
        ...
        (nn = {
          sendInit: function (n) {
            var e = C(x);
            s(e) && ((n = An(n, { apiKey: Y, pageId: $ }, x)), Tn(e, n));
          },
        }),
        T.sendStat("script_load"),
        {
          load: function (t) {
            ...
            var n = function () {
              "showcomments" === t.queryCommandValue("ToggleSidebar") &&
                (t.off("ToggleSidebar", n), T.sendStat("tinycomments_open"));
            };
