...
$sql = "SELECT * FROM phukien WHERE loai like '%airpods%' ";
...
function check_ban($ban) {
    $ban = addslashes($ban); 
    $gg = "SELECT * FROM phukien WHERE loai like '%airpods%' AND phien_ban = '$ban'";
    $check = getRow($gg);
    return count($check);  
}
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wishlish-compare">
                                                ...
                                                <a href="javascript:void(0)" class="setWishlist btn-wishlist"
                                                    data-wish="<?= $item['id']; ?>" tabindex="0" data-item="airpods"
