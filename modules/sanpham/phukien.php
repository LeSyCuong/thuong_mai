...
$selected_loai = $loai ? explode(',', $loai) : [];
...
if (!empty($selected_loai)) {
    $loai_conditions = array_map(function($condition) {
        // Đảm bảo giá trị nằm trong dấu nháy đơn và thoát ký tự đặc biệt
        return "loai like '%" . addslashes($condition) . " %' ";
    }, $selected_loai);
    ...
    if (!empty($price_conditions) || !empty($selected_tags) || !empty($selected_bo_nho) || !empty($selected_camera) || !empty($selected_ram) || !empty($selected_man_hinh)) {
        $sql .= " AND (" . implode(" OR ", $loai_conditions) . ")";
    } else {
        $sql .= " WHERE " . implode(" OR ", $loai_conditions);
    }
}
...
function check_ban($ban) {
    $ban = addslashes($ban); 
    $gg = "SELECT * FROM phukien WHERE loai like '%$ban%' ";
    $check = getRow($gg);
    return count($check);  
}
                ...
                <div class="danhmuc-slider swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events"
                    ...
                    <div class="swiper-wrapper"
                        ...
                        <div class="swiper-slide swiper-slide-active" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=phukien&loai=apple" title="Phụ kiện Apple">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif"
                                        data-src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif"
                                        alt="Phụ kiện Apple" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">Phụ kiện Apple</span>
                                    <span class="count">(<?php echo check_ban('apple'); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide swiper-slide-next" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=phukien&loai=coc" title="Cốc - Cáp">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif"
                                        data-src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif" alt="Cốc - Cáp"
                                        data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">Cốc - Cáp</span>
                                    <span class="count">(<?php echo check_ban('coc'); ?> sản phẩm)</span>
                            ...
                            <a href="?modules=sanpham&action=phukien&loai=sac" title="Sạc dự phòng">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif"
                                        data-src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif"
                                        alt="Sạc dự phòng" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">Sạc dự phòng</span>

                                    <span class="count">(<?php echo check_ban('sac'); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=phukien&loai=op-lung" title="Bao da - Ốp lưng">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif"
                                        data-src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif"
                                        alt="Bao da - Ốp lưng" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">Bao da - Ốp lưng</span>
                                    <span class="count">(<?php echo check_ban('op-lung'); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=phukien&loai=cuong-luc" title="Dán cường lực">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif"
                                        data-src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif"
                                        alt="Dán cường lực" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">Dán cường lực</span>

                                    <span class="count">(<?php echo check_ban('cuong-luc'); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=phukien&loai=mac" title="Phụ kiện MacBook">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif"
                                        data-src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif"
                                        alt="Phụ kiện MacBook" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">Phụ kiện MacBook</span>

                                    <span class="count">(<?php echo check_ban('mac'); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=phukien&loai=phim-chuot" title="Bàn phím - Chuột">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif"
                                        data-src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif"
                                        alt="Bàn phím - Chuột" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">Bàn phím - Chuột</span>

                                    <span class="count">(<?php echo check_ban('phim-chuot'); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=phukien&loai=balo" title="Balo - Túi chống shock">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif"
                                        data-src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif"
                                        alt="Balo - Túi chống shock" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">Balo - Túi chống shock</span>

                                    <span class="count">(<?php echo check_ban('balo'); ?> sản phẩm)</span>
                                    ...
                                    <form action="/cart/add" method="post" class="variants product-action"
                                        ...
                                        <div class="product-thumbnail">
                                            ...
                                            <div class="action">
                                                <button class="btn-cart btn-views" style="color: #fff;" title="Xem"
                                                    type="button"
                                                    onclick="window.location.href='?modules=view&action=view&loai=phukien&id=<?php echo $item['id']; ?>'">
                                                    Xem
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-info">
                                            <h3 class="product-name"><a
                                                    href="?modules=view&action=view&loai=phukien&id=<?php echo $item['id']; ?>"
                                            ...
                                            <div class="wishlish-compare">
                                                ...
                                                <a href="javascript:void(0)" class="setWishlist btn-wishlist"
                                                    data-wish="<?= $item['id']; ?>" tabindex="0" data-item="phukien"
