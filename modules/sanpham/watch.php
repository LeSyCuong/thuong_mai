...
function check_ban($ban) {
    $ban = addslashes($ban); 
    $gg = "SELECT * FROM watch WHERE phien_ban = '$ban'";
    $check = getRow($gg);
    return count($check);  
}
                ...
                <div class="danhmuc-slider swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events"
                    ...
                    <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                        ...
                        <div class="swiper-slide swiper-slide-active" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=watch&phien_ban=ultra" title="Apple Watch Ultra">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/aw-ultra-230217110022-2302251350-1.png?v=1700726080997"
                                        data-src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/aw-ultra-230217110022-2302251350-1.png?v=1700726080997"
                                        alt="Apple Watch Ultra" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">Apple Watch Ultra</span>

                                    <span class="count">(<?php echo check_ban('ultra'); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide swiper-slide-next" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=watch&phien_ban=S7" title="Apple Watch S7">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/aw-s7-230217110128-230225140014.png?v=1700726143190"
                                        data-src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/aw-s7-230217110128-230225140014.png?v=1700726143190"
                                        alt="Apple Watch S7" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">Apple Watch S7</span>

                                    <span class="count">(<?php echo check_ban('S7'); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=watch&phien_ban=SE" title="Apple Watch SE">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/aw-se-230217110144-230225135846.png?v=1700726117653"
                                        data-src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/aw-se-230217110144-230225135846.png?v=1700726117653"
                                        alt="Apple Watch SE" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">Apple Watch SE</span>

                                    <span class="count">(<?php echo check_ban('SE'); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=watch&phien_ban=S8" title="Apple Watch S8">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/aw-s8-230217110105-230225135856.png?v=1700726127803"
                                        data-src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/aw-s8-230217110105-230225135856.png?v=1700726127803"
                                        alt="Apple Watch S8" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">Apple Watch S8</span>

                                    <span class="count">(<?php echo check_ban('S8'); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=watch&phien_ban=S9" title="Apple Watch S9">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230914031301-compare-ultra2-vuaz.png?v=1700726172040"
                                        data-src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230914031301-compare-ultra2-vuaz.png?v=1700726172040"
                                        alt="Apple Watch S9" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">Apple Watch S9</span>

                                    <span class="count">(<?php echo check_ban('S9'); ?> sản phẩm)</span>
                                    ...
                                    <form action="/cart/add" method="post" class="variants product-action"
                                        ...
                                        <div class="product-thumbnail">
                                            ...
                                            <div class="action">
                                                <button class="btn-cart btn-views" style="color: #fff;" title="Xem"
                                                    type="button"
                                                    onclick="window.location.href='?modules=view&action=view&loai=watch&id=<?php echo $item['id']; ?>'">
                                                    Xem
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-info">
                                            <h3 class="product-name"><a
                                                    href="?modules=view&action=view&loai=watch&id=<?php echo $item['id']; ?>"
                                            ...
                                            <div class="wishlish-compare">
                                                ...
                                                <a href="javascript:void(0)" class="setWishlist btn-wishlist"
                                                    data-wish="<?= $item['id']; ?>" tabindex="0" data-item="watch"
