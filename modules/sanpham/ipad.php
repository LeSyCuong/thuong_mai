...
function check_ban($ban) {
    $ban = addslashes($ban); 
    $gg = "SELECT * FROM ipad WHERE phien_ban = '$ban'";
    $check = getRow($gg);
    return count($check);  
}
                    ...
                    <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                            ...
                            <a href="?modules=sanpham&action=ipad&phien_ban=pro" title="iPad Pro">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230725111835-icon-ipadpro1-23072.png?v=1700726013653"
                                        data-src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230725111835-icon-ipadpro1-23072.png?v=1700726013653"
                                        alt="iPad Pro" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">iPad Pro</span>
                                    <span class="count">(<?php echo check_ban('pro'); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide swiper-slide-next" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=ipad&phien_ban=air" title="iPad Air">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/icon-ipair-2-230224115802.png?v=1700725999027"
                                        data-src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/icon-ipair-2-230224115802.png?v=1700725999027"
                                        alt="iPad Air" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">iPad Air</span>

                                    <span class="count">(<?php echo check_ban('air'); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=ipad&phien_ban=gen-10" title="iPad Gen 10">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230224070446-10-91-230224190446.png?v=1700725961743"
                                        data-src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230224070446-10-91-230224190446.png?v=1700725961743"
                                        alt="iPad Gen 10" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">iPad Gen 10</span>
                                    <span class="count">(<?php echo check_ban('gen-10'); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=ipad&phien_ban=gen-9" title="iPad Gen 9">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230725104430-icon-ipadgen91-2307-1.png?v=1700725929320"
                                        data-src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230725104430-icon-ipadgen91-2307-1.png?v=1700725929320"
                                        alt="iPad Gen 9" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">iPad Gen 9</span>
                                    <span class="count">(<?php echo check_ban('gen-9'); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=ipad&phien_ban=mini" title="iPad mini">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="https://bizweb.dktcdn.net/thumb/large/100/502/883/collections/ipad-mini-230224190836.png?v=1700725981913"
                                        data-src="https://bizweb.dktcdn.net/thumb/large/100/502/883/collections/ipad-mini-230224190836.png?v=1700725981913"
                                        alt="iPad mini" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">iPad mini</span>
                                    ...
                                    <form action="/cart/add" method="post" class="variants product-action"
                                        ...
                                        <div class="product-thumbnail">
                                            ...
                                            <div class="action">
                                                <button class="btn-cart btn-views" style="color: #fff;" title="Xem"
                                                    type="button"
                                                    onclick="window.location.href='?modules=view&action=view&loai=ipad&id=<?php echo $item['id']; ?>'">
                                                    Xem
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-info">
                                            <h3 class="product-name"><a
                                                    href="?modules=view&action=view&loai=ipad&id=<?php echo $item['id']; ?>"
                                            ...
                                            <div class="wishlish-compare">
                                                ...
                                                <a href="javascript:void(0)" class="setWishlist btn-wishlist"
                                                    data-wish="<?= $item['id']; ?>" tabindex="0" data-item="ipad"
