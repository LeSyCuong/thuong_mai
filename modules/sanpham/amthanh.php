...
$sql = "SELECT * FROM phukien WHERE loai like '%amthanh%' ";
...
if ($gia) {
    ...
    if (!empty($price_conditions)) {
        $sql .= " AND ". implode(" AND ", $price_conditions);
    }
}
...
function check_ban($ban) {
    $ban = addslashes($ban); 
    $gg = "SELECT * FROM phukien WHERE loai like '%amthanh%' AND loai like '%$ban%'";
    $check = getRow($gg);
    return count($check);  
}
                            ...
                            <a href="?modules=sanpham&action=amthanh&loai=loa" title="Loa">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        ...
                                        data-src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif" alt="Loa"
                                        data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">Loa</span>
                                    <span class="count">(<?php echo check_ban('loa'); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide" style="width: 194px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=amthanh&loai=tainghe" title="Tai nghe">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif"
                                        data-src="//bizweb.dktcdn.net/assets/themes_support/noimage.gif" alt="Tai nghe"
                                        data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">Tai nghe</span>

                                    <span class="count">(<?php echo check_ban('tainghe'); ?> sản phẩm)</span>
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wishlish-compare">
                                                ...
                                                <a href="javascript:void(0)" class="setWishlist btn-wishlist"
                                                    data-wish="<?= $item['id']; ?>" tabindex="0" data-item="amthanh"
