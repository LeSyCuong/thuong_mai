...
function check_ban($ban) {
    $gg = 'SELECT * FROM iphone WHERE phien_ban = ' . intval($ban);  
    $check = getRow($gg);
    return count($check);  
}
?>
            ...
            <section class="section_danhmuc">
                ...
                <div class="danhmuc-slider swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events"
                    ...
                    <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                        ...
                        <div class="swiper-slide swiper-slide-active" style="width: 166px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=iphone&phien_ban=15" title="iPhone 15 Series">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230918040730-ip15pm1-23091816073-1.png?v=1700726494730"
                                        data-src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230918040730-ip15pm1-23091816073-1.png?v=1700726494730"
                                        alt="iPhone 15 Series" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">iPhone 15 Series</span>

                                    <span class="count">(<?php echo check_ban(15); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide swiper-slide-next" style="width: 166px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=iphone&phien_ban=14" title="iPhone 14 Series">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230725085419-14prm1-230725085419.png?v=1700726513700"
                                        data-src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230725085419-14prm1-230725085419.png?v=1700726513700"
                                        alt="iPhone 14 Series" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">iPhone 14 Series</span>

                                    <span class="count">(<?php echo check_ban(14); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide" style="width: 166px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=iphone&phien_ban=13" title="iPhone 13">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230725085349-ip13-2303011051521.png?v=1700726532090"
                                        data-src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230725085349-ip13-2303011051521.png?v=1700726532090"
                                        alt="iPhone 13" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">iPhone 13</span>

                                    <span class="count">(<?php echo check_ban(13); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide" style="width: 166px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=iphone&phien_ban=12" title="iPhone 12">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230725085451-ip121-230725085451.png?v=1700726552913"
                                        data-src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230725085451-ip121-230725085451.png?v=1700726552913"
                                        alt="iPhone 12" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">iPhone 12</span>
                                    <span class="count">(<?php echo check_ban(12); ?> sản phẩm)</span>
                        ...
                        <div class="swiper-slide" style="width: 166px; margin-right: 10px;">
                            <a href="?modules=sanpham&action=iphone&phien_ban=11" title="iPhone 11">
                                <div class="thumb">
                                    <img width="80" height="80" class="lazyload loaded"
                                        src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230725085520-ip111-230725085520.png?v=1700726572467"
                                        data-src="//bizweb.dktcdn.net/thumb/large/100/502/883/collections/230725085520-ip111-230725085520.png?v=1700726572467"
                                        alt="iPhone 11" data-was-processed="true">

                                </div>
                                <h3>
                                    <span class="line-clamp line-clamp-1">iPhone 11</span>
                                    <span class="count">(<?php echo check_ban(11); ?> sản phẩm)</span>
                                        ...
                                        <div class="product-thumbnail">
                                            ...
                                            <div class="action">
                                                <button class="btn-cart btn-views" style="color: #fff;" title="Xem"
                                                    type="button"
                                                    onclick="window.location.href='?modules=view&action=view&loai=iphone&id=<?php echo $item['id']; ?>'">Xem</button>
                                            </div>
                                        </div>
                                        <span class="smart">Giảm <?php echo $item['giam'];?>%</span>
                                        <div class="product-info">
                                            <h3 class="product-name">
                                                <a href="?modules=view&action=view&loai=iphone&id=<?php echo $item['id']; ?>"
                                                    title="<?php echo $item['ten_san_pham']; ?>">
                                            ...
                                            <div class="pro-promo ">
                                                <p class="line-clamp line-clamp-2"><?php echo $item['bao_hanh']; ?></p>
                                            </div>
                                            <div class="wishlish-compare">

                                                <a href="javascript:void(0)" class="setWishlist btn-wishlist"
                                                    data-wish="<?= $item['id']; ?>" tabindex="0" data-item="iphone"
